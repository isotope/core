...
$GLOBALS['TL_LANG']['tl_iso_attributes']['description']				= array('Description', 'Please enter a description for this attribute.');
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['field_name']				= array('Internal name', 'Internal field name must be unique to this attribute set. Some field labels are mandatory (product name etc.) and cannot be edited.');
$GLOBALS['TL_LANG']['tl_iso_attributes']['type']					= array('Type', 'Please select a type for this attribute.');
$GLOBALS['TL_LANG']['tl_iso_attributes']['option_list']				= array('Options', 'Please enter one or more options. Use the buttons to add, move or delete an option. If you are working without JavaScript assistance, you should save your changes before you modify the order!');
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['storeTable']				= array('Storage Table','What table does this attribute produce a field for?');
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['rgxp']					= array('Check Field Values', 'Ensure user input is valid based on a rule you select.');
$GLOBALS['TL_LANG']['tl_iso_attributes']['list_source_table']		= array('List Source Table','the table selected will be used to populate the list using the ID value of this table');
$GLOBALS['TL_LANG']['tl_iso_attributes']['list_source_field']		= array('List Source Field','this field will be the label for each value that comes from the list source table.');
$GLOBALS['TL_LANG']['tl_iso_attributes']['use_alternate_source']	= array('Alternate List Source','Check this if you would like to use a database table as the data source.');
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['template_key']			= 'Template Key: ';
$GLOBALS['TL_LANG']['tl_iso_attributes']['template_visibility_title']	= 'Available In The Following Templates: ';
 ...
 * Reference
 */
$GLOBALS['TL_LANG']['tl_iso_attributes']['rgxpOptions']['alnum']	= 'Numbers and Letters Only';
$GLOBALS['TL_LANG']['tl_iso_attributes']['rgxpOptions']['extnd']	= 'All standard characters except: #&()/>=<';
$GLOBALS['TL_LANG']['tl_iso_attributes']['rgxpOptions']['email']	= 'Valid email address';
$GLOBALS['TL_LANG']['tl_iso_attributes']['rgxpOptions']['url']		= 'Valid html link';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['deleteConfirm'] 			= 'Do you really want to delete ID %s. Database field is not dropped, you need to manually update the database using the install tool or repository manager.';
