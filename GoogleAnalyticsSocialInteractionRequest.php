...
class GoogleAnalyticsSocialinteractionRequest extends GoogleAnalyticsPageviewRequest {
	...
	protected function getType() {
		return GoogleAnalyticsRequest::TYPE_SOCIAL;
	}
	 ...
	 */
	public function setSocialInteraction(GoogleAnalyticsSocialInteraction $socialInteraction) {
