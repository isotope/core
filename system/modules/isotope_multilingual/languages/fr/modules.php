 ...
 * Extension folder
 */
$GLOBALS['TL_LANG']['MOD']['isotope_multilingual'] = array('Isotope eCommerce: support multilingue');
...
$GLOBALS['TL_LANG']['IMD']['iso_labels'][1]      = 'Divers libellés Isotope eCommerce devraient être traduit pour soutenir un magasin multilingue. Quelques exemples sont des noms de module de paiement et des options d\'attributs de produits. Grâce à cet outil, vous pouvez traduire les libellés en plusieurs langues. La plupart des champs affichent une liste avec complètement automatique de la saisie au clavier des libellés disponibles (autocomplete list). En outre, vous pouvez utiliser la balise d\'insertion {{isolabel::???}} pour remplacer un libellé.';
