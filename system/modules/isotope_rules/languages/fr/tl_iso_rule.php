...
$GLOBALS['TL_LANG']['tl_iso_rule']['label'][0] = 'Libellé';
...
$GLOBALS['TL_LANG']['tl_iso_rule']['discount'][0] = 'Remise';
...
$GLOBALS['TL_LANG']['tl_iso_rule']['startDate'][0] = 'Afficher à partir du';
...
$GLOBALS['TL_LANG']['tl_iso_rule']['groups'][0] = 'Groupes';
...
$GLOBALS['TL_LANG']['tl_iso_rule']['products'][0] = 'Produits';
...
$GLOBALS['TL_LANG']['tl_iso_rule']['enabled'][0] = 'Activé';
