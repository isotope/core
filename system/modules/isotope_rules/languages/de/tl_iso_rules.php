...
$GLOBALS['TL_LANG']['tl_iso_rules']['tax_class'][0] = 'Steuerklasse';
...
$GLOBALS['TL_LANG']['tl_iso_rules']['configCondition'][0] = 'Bedingung der Shop-Konfiguration';
$GLOBALS['TL_LANG']['tl_iso_rules']['configCondition'][1] = 'Definieren Sie ob die Auswahl passen soll oder nicht.';
...
$GLOBALS['TL_LANG']['tl_iso_rules']['memberCondition'][0] = 'Bedingung für Mitglieder';
$GLOBALS['TL_LANG']['tl_iso_rules']['memberCondition'][1] = 'Definieren Sie ob die Auswahl passen soll oder nicht.';
...
$GLOBALS['TL_LANG']['tl_iso_rules']['productRestrictions']['variants'] = 'Produkte &amp; Varianten';
$GLOBALS['TL_LANG']['tl_iso_rules']['productRestrictions']['attribute'] = 'Produktattribute';
$GLOBALS['TL_LANG']['tl_iso_rules']['productCondition'][0] = 'Produktbedingungen';
$GLOBALS['TL_LANG']['tl_iso_rules']['productCondition'][1] = 'Definieren Sie ob die Auswahl passen soll oder nicht.';
...
$GLOBALS['TL_LANG']['tl_iso_rules']['variants'][0] = 'Produkte & Varianten';
$GLOBALS['TL_LANG']['tl_iso_rules']['variants'][1] = 'Wählen Sie auf welche Produkte & Varianten diese Regel beschränkt ist. Falls Sie keine wählen, gilt sie für alle.';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeName'][0] = 'Namens-Attribut';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeName'][1] = 'Wählen Sie die Produkteigenschaft welcher eingeschränkt werden soll.';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition'][0] = 'Attributbedingungen';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition'][1] = 'Wählen Sie das zu beschränkende Produktattribut.';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['eq'] = 'ist gleich';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['neq'] = 'ist nicht gleich';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['lt'] = 'weniger als';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['gt'] = 'größer als';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['elt'] = 'weniger als oder ist gleich';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['egt'] = 'größer als oder ist gleich';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['starts'] = 'Beginnt mit';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['ends'] = 'Endet mit';
$GLOBALS['TL_LANG']['tl_iso_rules']['attributeCondition']['contains'] = 'beinhaltet';
...
$GLOBALS['TL_LANG']['tl_iso_rules']['condition_true'] = 'wahr';
$GLOBALS['TL_LANG']['tl_iso_rules']['condition_false'] = 'falsch';
...
$GLOBALS['TL_LANG']['tl_iso_rules']['toggle'][0] = 'Regel veröffentlichen/unveröffentlichten';
$GLOBALS['TL_LANG']['tl_iso_rules']['toggle'][1] = 'Regel mit ID %s veröffentlichen/unveröffentlichten';
