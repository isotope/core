...
$GLOBALS['TL_LANG']['tl_iso_rules']['startTime'][0] = 'Startdatum';
$GLOBALS['TL_LANG']['tl_iso_rules']['startTime'][1] = 'Falls gewollt, geben Sie hier an ab welchem Datum diese Regel zur Verfügung steht.';
$GLOBALS['TL_LANG']['tl_iso_rules']['endTime'][0] = 'Enddatum';
$GLOBALS['TL_LANG']['tl_iso_rules']['endTime'][1] = 'Falls gewollt, geben Sie hier ab welchem Datum diese Regel nicht mehr zur Verfügung steht.';
...
$GLOBALS['TL_LANG']['tl_iso_rules']['applyTo']['product'] = 'für jedes Produkt';
$GLOBALS['TL_LANG']['tl_iso_rules']['applyTo']['item'] = 'für jede Einheit eines Produktes';
$GLOBALS['TL_LANG']['tl_iso_rules']['applyTo']['cart'] = 'für den Warenkorb-Gesamtwert';
