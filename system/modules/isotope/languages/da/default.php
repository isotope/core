...
$GLOBALS['ISO_LANG']['SHIP']['weighttotal'][0] = 'Vægt-baseret levering';
$GLOBALS['ISO_LANG']['SHIP']['ordertotal'][0] = 'Ordre total-baseret levering';
...
$GLOBALS['ISO_LANG']['PRODUCT']['standard'][1] = 'Et standard produkt. Vælg denne hvis ikke andet passer.';
