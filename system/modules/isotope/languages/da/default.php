...
$GLOBALS['TL_LANG']['PAY']['cybersource'][1] = 'For Cybersource brugere. Brug Simple Order API metoden.';
...
$GLOBALS['TL_LANG']['GAL']['inline'][0] = 'Inline galleri';
...
$GLOBALS['TL_LANG']['ATTR']['text'][1] = 'En enkelt linje for en kort eller mellemlang tekst (op til 255 tegn).';
$GLOBALS['TL_LANG']['ATTR']['textarea'][0] = 'Tekstafsnit';
$GLOBALS['TL_LANG']['ATTR']['textarea'][1] = 'Til længere tekster med flere linjer.';
...
$GLOBALS['TL_LANG']['ATTR']['mediaManager'][0] = 'Media (billeder, film, MP3 m.m.)';
