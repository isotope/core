...
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['slabel'][0] = 'Etichetta';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['slabel'][1] = 'Questo sarà visualizzata nel frontend associata all\'opzione di spedizione.';
