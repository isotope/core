...
$GLOBALS['TL_LANG']['tl_content']['iso_reader_jumpTo'][1] = 'L\'impostazione definisce a quale pagina un utilizzatore sarà reindirizzato quando fa click su un prodotto per ottenere più informazioni.';
$GLOBALS['TL_LANG']['tl_content']['iso_list_layout'][0] = 'Template elenco prodotti';
