...
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['value'][0] = 'Valore';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['label'][0] = 'Ettichetta';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['default'][0] = 'Preimpostato';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['group'][0] = 'Gruppo';
