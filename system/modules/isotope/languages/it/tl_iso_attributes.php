...
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_customer_defined'][0] = 'Definito dal Cliente';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_customer_defined'][1] = 'Per cortesia selezioni se questo valore è definito dal cliente (frontend).';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_order_by_enabled'][0] = 'Aggiungi all\'elenco l\'opzione "Ordina per"';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_order_by_enabled'][1] = 'Questo campo sarà ordinabile nel modulo elenco a patto che l\'attributo sia visibile ai clienti.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_be_filterable'][0] = 'Backend Filtrabile';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_be_filterable'][1] = 'Può questo attributo essere utilizzato in un filtro backend?';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_be_searchable'][0] = 'Ricercabile Backend';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_be_searchable'][1] = 'Questo motore di ricerca deve usare questo campo per i termini di ricerca?';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_filterable'][0] = 'Frontend Filtrabile';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_filterable'][1] = 'Può questo attributo essere usato in un filtro frontend?';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_searchable'][0] = 'Frontend Ricercabile';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_searchable'][1] = 'Questo motore di ricerca deve usare questo campo per i termini di ricerca?';
$GLOBALS['TL_LANG']['tl_iso_attributes']['opValue'] = 'Valore';
$GLOBALS['TL_LANG']['tl_iso_attributes']['opLabel'] = 'Ettichetta';
$GLOBALS['TL_LANG']['tl_iso_attributes']['opDefault'] = 'Preimpostato';
$GLOBALS['TL_LANG']['tl_iso_attributes']['opGroup'] = 'Gruppo';
