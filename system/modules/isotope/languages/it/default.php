...
$GLOBALS['TL_LANG']['ERR']['emptyDownloadsFolder'] = 'La cartella selezionata è vuota.';
$GLOBALS['TL_LANG']['ERR']['collectionItemNotAvailable'] = 'Questo prodotto non è più disponibile.';
$GLOBALS['TL_LANG']['MSC']['filterByGroups'] = 'Gruppi';
$GLOBALS['TL_LANG']['MSC']['filterByPages'] = 'Pagine';
...
$GLOBALS['TL_LANG']['MSC']['buttonLabel']['update_cart'] = 'Aggiornare il carrello';
...
$GLOBALS['TL_LANG']['MSC']['editProductLinkText'] = 'Modificare';
...
$GLOBALS['TL_LANG']['MSC']['cartBT'] = 'Carrello Spesa';
...
$GLOBALS['TL_LANG']['MSC']['iso_order_description'] = 'Descrizione';
$GLOBALS['TL_LANG']['MSC']['iso_order_quantity'] = 'Quantità';
$GLOBALS['TL_LANG']['MSC']['iso_order_price'] = 'Prezzo';
$GLOBALS['TL_LANG']['MSC']['iso_order_total'] = 'Totale';
...
$GLOBALS['TL_LANG']['MSC']['checkout_address'] = 'Indirizzo';
$GLOBALS['TL_LANG']['MSC']['checkout_shipping'] = 'Spedizione';
$GLOBALS['TL_LANG']['MSC']['checkout_payment'] = 'Pagamento';
$GLOBALS['TL_LANG']['MSC']['checkout_review'] = 'Recensione';
$GLOBALS['TL_LANG']['MSC']['billing_address'] = 'Indirizzo Fattura';
$GLOBALS['TL_LANG']['MSC']['shipping_address'] = 'Indirizzo Spedizione';
$GLOBALS['TL_LANG']['MSC']['changeCheckoutInfo'] = 'Cambio';
$GLOBALS['TL_LANG']['MSC']['cc_num'] = 'Numero carta di credito';
$GLOBALS['TL_LANG']['MSC']['productcacheLoading'] = 'Caricamento prodotti...';
$GLOBALS['TL_LANG']['MSC']['noFilesInFolder'] = 'Nessun file in questa cartella';
$GLOBALS['TL_LANG']['MSC']['timePeriod']['minutes'] = 'Minuti';
$GLOBALS['TL_LANG']['MSC']['timePeriod']['hours'] = 'Ore';
$GLOBALS['TL_LANG']['MSC']['timePeriod']['days'] = 'Giorni';
$GLOBALS['TL_LANG']['MSC']['timePeriod']['weeks'] = 'Settimane';
$GLOBALS['TL_LANG']['MSC']['timePeriod']['months'] = 'Mesi';
$GLOBALS['TL_LANG']['MSC']['timePeriod']['years'] = 'Anni';
$GLOBALS['TL_LANG']['MSC']['isotopeIntroduction'][0] = 'Benvenuto su Isotope eCommerce';
...
$GLOBALS['TL_LANG']['ATTR']['downloads'][0] = 'Download';
