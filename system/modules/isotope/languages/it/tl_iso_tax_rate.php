...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['country'][0] = 'Paese';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['country'][1] = 'Selezioni un paese al quale applicare questa classe di aliquota.';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['subdivision'][0] = 'Stato/Regione';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['subdivision'][1] = 'Selezioni uno stato o una regione al quale applicare questa classe di aliquota.';
...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['rate'][1] = 'La tariffa fissata in percentuale';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['config'][0] = 'Configurazione negozio';
...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['edit'][1] = 'Modifica aliquota d\'imposta %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['copy'][0] = 'Copia aliquota d\'imposta';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['copy'][1] = 'Copia aliquota d\'imposta ID %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['delete'][0] = 'Cancella aliquota d\'imposta';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['delete'][1] = 'Cancella aliquota d\'imposta %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['show'][0] = 'Dettagli Ordine';
