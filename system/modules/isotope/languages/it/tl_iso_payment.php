...
$GLOBALS['TL_LANG']['tl_iso_payment']['quantity_mode'][0] = 'Modalità quantità calcolo ';
$GLOBALS['TL_LANG']['tl_iso_payment']['quantity_mode'][1] = 'Selezionare una modalità calcolo per una quantità minima/massima.';
$GLOBALS['TL_LANG']['tl_iso_payment']['quantity_mode']['cart_items'] = 'Quantità totale nel carrello ';
$GLOBALS['TL_LANG']['tl_iso_payment']['quantity_mode']['cart_products'] = 'Prodotti totali nel carrello ';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['psp_payment_method'][0] = 'Metodo di pagamento';
