...
$GLOBALS['TL_LANG']['tl_iso_orders']['date_paid'][0] = 'Data pagamento';
$GLOBALS['TL_LANG']['tl_iso_orders']['date_paid'][1] = 'Inserisca una data quando questo ordine sarà stato pagato';
