...
$GLOBALS['TL_LANG']['tl_iso_product_collection']['config_id'][0] = 'Winkelconfiguratie';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['payment_id'][0] = 'Betaalmethode';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['shipping_id'][0] = 'Verzendmethode';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['billing_address_id'][0] = 'Factuuradres';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['shipping_address_id'][0] = 'Verzendadres';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['subtotal'][0] = 'subtotaal';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['tax_free_subtotal'][0] = 'Subtotaal zonder BTW';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['total'][0] = 'Totaal';
...
$GLOBALS['TL_LANG']['tl_iso_product_collection']['language'][0] = 'Taal';
...
$GLOBALS['TL_LANG']['tl_iso_product_collection']['edit'][1] = 'Wijzig bestel nr. %s';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['copy'][0] = 'Kopieër bestelling';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['copy'][1] = 'Kopieër bestel nr. %s';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['delete'][0] = 'Verwijder bestelling';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['delete'][1] = 'Verwijder bestel nr. %s';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['show'][0] = 'Details van de bestelling';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['show'][1] = 'Laat detail van bestel nr. %s zien';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['print_document'][0] = 'Druk een document af';
...
$GLOBALS['TL_LANG']['tl_iso_product_collection']['email_legend'] = 'E-mailgegevens';
