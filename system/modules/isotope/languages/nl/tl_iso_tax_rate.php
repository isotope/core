...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['country'][1] = 'Selecteer het land waarop dit belastingtarief van toepassing is.';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['subdivision'][0] = 'Provincie/Regio';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['subdivision'][1] = 'Selecteer de provincie/regio waarop dit belastingtarief van toepassing is.';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['postal'][0] = 'Postcode reeks';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['postal'][1] = 'Selecteer een postcode reeks waarop dit belastingtarief van toepassing is.';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['amount'][0] = 'Beperking subtotaal bedragen';
...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['new'][1] = 'Creëer een nieuw belastingtarief';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['edit'][0] = 'Wijzig belastingtarief';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['edit'][1] = 'Wijzig belastingtarief ID %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['copy'][0] = 'Dupliceer belastingtarief';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['copy'][1] = 'Dupliceer belastingtarief ID %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['delete'][0] = 'Verwijder belastingtarief';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['delete'][1] = 'Verwijder belastingtarief ID %s';
