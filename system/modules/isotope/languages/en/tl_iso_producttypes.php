...
$GLOBALS['TL_LANG']['tl_iso_producttypes']['list_template']         = array('List template', 'Select a template for product listing.');
$GLOBALS['TL_LANG']['tl_iso_producttypes']['reader_template']       = array('Reader template', 'Select a template for product details.');
$GLOBALS['TL_LANG']['tl_iso_producttypes']['list_gallery']          = array('List gallery', 'Select a gallery for product listing.');
$GLOBALS['TL_LANG']['tl_iso_producttypes']['reader_gallery']        = array('Reader gallery', 'Select a gallery for product details.');
