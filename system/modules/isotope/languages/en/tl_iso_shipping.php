 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_iso_shipping']['name']              = array('Shipping Method Name');
$GLOBALS['TL_LANG']['tl_iso_shipping']['type']              = array('Shipping Method Type');
$GLOBALS['TL_LANG']['tl_iso_shipping']['price']             = array('Price');
...
$GLOBALS['TL_LANG']['tl_iso_shipping']['tax_class']         = array('Tax Class');
...
$GLOBALS['TL_LANG']['tl_iso_shipping']['flatCalculation']   = array('Flat calculation');
...
$GLOBALS['TL_LANG']['tl_iso_shipping']['minimum_total']     = array('Minimum total');
$GLOBALS['TL_LANG']['tl_iso_shipping']['maximum_total']     = array('Maximum total');
