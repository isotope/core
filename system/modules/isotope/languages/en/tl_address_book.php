 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_address_book']['personal_legend'] = 'Personal data';
$GLOBALS['TL_LANG']['tl_address_book']['address_legend']  = 'Address details';
$GLOBALS['TL_LANG']['tl_address_book']['contact_legend']  = 'Contact details';
$GLOBALS['TL_LANG']['tl_address_book']['default_legend']  = 'Default address';
...
$GLOBALS['TL_LANG']['tl_address_book']['show']   = array('Address details', 'Show details of address ID %s');
$GLOBALS['TL_LANG']['tl_address_book']['edit']   = array('Edit address', 'Edit address ID %s');
