...
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsTable']            = array('Options', 'Use the options manager to add your options to the field.');
$GLOBALS['TL_LANG']['tl_iso_attribute']['includeBlankOption']      = array('Include blank option', 'Check here to include a blank option in the select menu.');
...
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsTable_edit']       = 'Edit options';
