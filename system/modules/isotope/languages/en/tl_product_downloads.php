...
$GLOBALS['TL_LANG']['tl_product_downloads']['show']					= array('Download details', 'Show details of download ID %s');


/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_product_downloads']['file_legend']			= 'Attachement';
$GLOBALS['TL_LANG']['tl_product_downloads']['name_legend']			= 'Title & Description';
$GLOBALS['TL_LANG']['tl_product_downloads']['limit_legend']			= 'Limits';
