...
$GLOBALS['TL_LANG']['tl_payment_modules']['paypalpro_apiUserName']  = array('Paypal Website Payments Pro username','');
$GLOBALS['TL_LANG']['tl_payment_modules']['paypalpro_apiPassword']  = array('Paypal Website Payments Pro password','An alphanumeric string similar in format to this: QFZCWN5HZM8VBG7Q');
$GLOBALS['TL_LANG']['tl_payment_modules']['paypalpro_apiSignature'] = array('Paypal Website Payments Pro api signature','An alphanumeric string similar in format to this: A-IzJhZZjhg29XQ2qnhapuwxIDzyAZQ92FRP5dqBzVesOkzbdUONzmOU');
...
$GLOBALS['TL_LANG']['tl_payment_modules']['paypalpro_legend']	= 'PayPal Website Payments Pro Configuration';
