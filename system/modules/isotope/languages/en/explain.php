...
$GLOBALS['TL_LANG']['XPL']['isoMailTokens'][4]	= array('##taxTotal##', 'Total of tax (excluding shipping)');
$GLOBALS['TL_LANG']['XPL']['isoMailTokens'][5]	= array('##shippingPrice##', 'Shipping Price Total');
