...
$GLOBALS['TL_LANG']['tl_iso_config']['order_moveUploads']           = array('Move uploads on successful order', 'Re-organize files after an order has been completed.');
$GLOBALS['TL_LANG']['tl_iso_config']['order_uploadTarget']          = array('Target folder', 'Select the folder where to move the files. Isotope will create necessary subfolders based on order number etc.');
...
$GLOBALS['TL_LANG']['tl_iso_config']['net']                         = array('Net', 'Show net prices to all customers. Taxes included in the product price (tax rate configuration) will be deducted.');
