...
$GLOBALS['TL_LANG']['tl_iso_config']['markNewDays']                      = array('Days to mark a product as "new"', 'If you would like to highlight new products, you can enter the number of days here. It will automatically add a CSS class "new" to every product everywhere within Isotope eCommerce.');
