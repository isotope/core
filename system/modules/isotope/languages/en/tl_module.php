...
$GLOBALS['TL_LANG']['tl_module']['iso_display404Page']              = array('Display a 404 page', 'Display a 404 not found page if the product is not found. Use with caution if the product list is on the same page!');
