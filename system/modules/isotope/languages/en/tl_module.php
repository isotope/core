...
$GLOBALS['TL_LANG']['tl_module']['iso_skip_shipping']               = array('Skip shipping step', 'Skips the shipping step if only one shippig method is available.');
$GLOBALS['TL_LANG']['tl_module']['iso_skip_payment']                = array('Skip payment step', 'Skips the payment step if only one payment method is available.');
...
$GLOBALS['TL_LANG']['tl_module']['iso_address']                     = array('Address types', 'Please choose the address types.');
$GLOBALS['TL_LANG']['tl_module']['iso_addressFields']               = array('Available address fields', 'Choose the available address fields you would like to display.');
