...
$GLOBALS['TL_LANG']['tl_module']['iso_noProducts']				= array('Message for empty listing', 'Leave blank for the default message.');
$GLOBALS['TL_LANG']['tl_module']['iso_forceNoProducts']			= array('Force empty message', 'Use "Empty message for listing" even if it is blank.');
...
$GLOBALS['TL_LANG']['tl_module']['iso_perPage']					= array('Per page options', 'Enter a comma separated list for the limit dropdown.');
