...
$GLOBALS['TL_LANG']['tl_module']['iso_orderCollectionBy']['id_asc']                     = 'by date added (ascending)';
$GLOBALS['TL_LANG']['tl_module']['iso_orderCollectionBy']['id_desc']                    = 'by date added (descending)';
$GLOBALS['TL_LANG']['tl_module']['iso_orderCollectionBy']['tstamp_asc']                 = 'by date updated (ascending)';
$GLOBALS['TL_LANG']['tl_module']['iso_orderCollectionBy']['tstamp_desc']                = 'by date updated (descending)';
$GLOBALS['TL_LANG']['tl_module']['iso_orderCollectionBy']['name_asc']                   = 'by product name (ascending)';
$GLOBALS['TL_LANG']['tl_module']['iso_orderCollectionBy']['name_desc']                  = 'by product name (descending)';
$GLOBALS['TL_LANG']['tl_module']['iso_orderCollectionBy']['price_asc']                  = 'by price (ascending)';
$GLOBALS['TL_LANG']['tl_module']['iso_orderCollectionBy']['price_desc']                 = 'by price (descending)';
