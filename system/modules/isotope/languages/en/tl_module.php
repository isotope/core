...
$GLOBALS['TL_LANG']['tl_module']['iso_notification_collectionTpl']  = array('Notification product collection template', 'Please choose a template to render the products for the notification content.');
$GLOBALS['TL_LANG']['tl_module']['iso_notification_document']       = array('Notification document', 'If you would like to attach a document to the notification, choose one here and use the simple token in the notification center.');
