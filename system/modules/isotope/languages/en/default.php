...
$GLOBALS['TL_LANG']['MSC']['buttonLabel']['add_all_to_cart']       = 'Add All To Cart';
$GLOBALS['TL_LANG']['MSC']['buttonLabel']['update_cart']           = 'Update Cart';
$GLOBALS['TL_LANG']['MSC']['buttonLabel']['add_to_favorites']      = 'Add To Favorites';
$GLOBALS['TL_LANG']['MSC']['buttonLabel']['remove_from_favorites'] = 'Remove From Favorites';
...
$GLOBALS['TL_LANG']['MSC']['noItemsInFavorites']                   = 'There are no items in your favorites list.';
$GLOBALS['TL_LANG']['MSC']['noItemsInCart']                        = 'There are no items in your cart.';
$GLOBALS['TL_LANG']['MSC']['addedToFavorites']                     = 'The selected product has been added to your favorites.';
$GLOBALS['TL_LANG']['MSC']['removedFromFavorites']                 = 'The selected product has been removed to your favorites.';
