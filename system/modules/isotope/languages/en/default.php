...
$GLOBALS['TL_LANG']['MSC']['invalidProductInformation'] = 'We_'re sorry, the product information you have requested is not showing up in our store. For further assistance please contact us.';
...
$GLOBALS['TL_LANG']['MSC']['thumbnailImageClickEvent'] = 'class="highslide" onclick="return hs.expand(this, { slideshowGroup: _'productImages_' })"';
