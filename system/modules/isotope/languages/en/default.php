...
$GLOBALS['TL_LANG']['GAL']['inline']			= array('Inline gallery', '<p>Clicking on the gallery image will load it instead of the main image. You should upload the main image twice to have it available in the gallery.</p>');
