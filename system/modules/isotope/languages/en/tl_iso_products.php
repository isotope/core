...
$GLOBALS['TL_LANG']['tl_iso_products']['meta_title']                = array('Meta title', 'Meta title is used as page title in the product detail view. If you leave it empty, the product name will be used.');
$GLOBALS['TL_LANG']['tl_iso_products']['meta_description']          = array('Meta description', 'Meta description will be placed in the header on product detail page, for search engine optimization.');
$GLOBALS['TL_LANG']['tl_iso_products']['meta_keywords']             = array('Meta keywords', 'Meta keywords will be placed in the header on product detail page, for search engine optimization.');
