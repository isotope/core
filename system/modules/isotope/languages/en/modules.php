...
$GLOBALS['TL_LANG']['FMD']['iso_shipping_calculator_form']  = array('Shipping cost calculator form', 'Displays a form to enter the address data that will be used to calculate the shipping costs.');
