...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['countries']				= array('Available countries', 'Select the countries where this payment methos may be used (customer\'s billing address).');
