...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['HOLD_FOR_ADJUST']	= array('Hold for adjustments','Transactions of this type will not be sent to the gateway until the order total has been adjusted.  Use this if you expect to have to increase order totals to account for shipping calculations or other upward fluctuations in order total.');
