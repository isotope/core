...
$GLOBALS['TL_LANG']['tl_iso_products']['id'][0] = 'Идентификатор товара';
$GLOBALS['TL_LANG']['tl_iso_products']['pages'][0] = 'Категории';
$GLOBALS['TL_LANG']['tl_iso_products']['type'][0] = 'Тип товара';
$GLOBALS['TL_LANG']['tl_iso_products']['alias'][0] = 'Синоним';
