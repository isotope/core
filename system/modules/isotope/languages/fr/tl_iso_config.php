...
$GLOBALS['TL_LANG']['tl_iso_config']['store_id'][1]                  = 'Utiliser des ID de boutique différents pour regrouper un ensemble de configurations de boutique. Un panier de commande sera partagé entre les mêmes ID de boutique.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_error']            = array('État des commandes en cas d\'erreur', 'Sélectionnez un état de la commande en cas d\'erreur (par exemple : le paiement).');
...
$GLOBALS['TL_LANG']['tl_iso_config']['shipping_fields'][1]           = 'Sélectionner les champs qui seront affichés lors de la création d\'une nouvelle adresse de livraison.';
$GLOBALS['TL_LANG']['tl_iso_config']['shipping_country']             = array('Pays de livraison par défaut', 'Sélectionnez un pays par défaut pour les nouvelles adresses de livraison.');
