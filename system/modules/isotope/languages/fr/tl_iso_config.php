...
$GLOBALS['TL_LANG']['tl_iso_config']['fallback'][0] = 'Définir une boutique par défaut';
...
$GLOBALS['TL_LANG']['tl_iso_config']['subdivision'][0] = 'Etat';
...
$GLOBALS['TL_LANG']['tl_iso_config']['limitMemberCountries'][0] = 'Limiter aux pays des membres';
$GLOBALS['TL_LANG']['tl_iso_config']['enableGoogleAnalytics'][0] = 'Activer le suivi commerce électronique de Google Analytics';
$GLOBALS['TL_LANG']['tl_iso_config']['gallery'][0] = 'Galerie d\'image de produit';
$GLOBALS['TL_LANG']['tl_iso_config']['imageSizes'][0] = 'Tailles de l\'image';
...
$GLOBALS['TL_LANG']['tl_iso_config']['edit'][0] = 'Editer la configuration';
$GLOBALS['TL_LANG']['tl_iso_config']['edit'][1] = 'Editer la configuration de boutique ID %s.';
