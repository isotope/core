...
$GLOBALS['TL_LANG']['tl_iso_config']['name'][1] = 'Veuillez entrer un nom pour la configuration. Ce n\'est utilisé que dans le back office';
...
$GLOBALS['TL_LANG']['tl_iso_config']['lastname'][0] = 'Nom de famille';
$GLOBALS['TL_LANG']['tl_iso_config']['lastname'][1] = 'Saisir le nom.';
$GLOBALS['TL_LANG']['tl_iso_config']['company'][0] = 'Entreprise';
$GLOBALS['TL_LANG']['tl_iso_config']['company'][1] = 'Saisir la société.';
$GLOBALS['TL_LANG']['tl_iso_config']['vat_no'][0] = 'Numéro de TVA';
$GLOBALS['TL_LANG']['tl_iso_config']['vat_no'][1] = 'Veuillez entrer un numéro de TVA.';
$GLOBALS['TL_LANG']['tl_iso_config']['street_1'][0] = 'Rue';
$GLOBALS['TL_LANG']['tl_iso_config']['street_1'][1] = 'Saisir la rue et le numéro de rue.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['city'][1] = 'Veuillez entrer le nom de la ville.';
$GLOBALS['TL_LANG']['tl_iso_config']['subdivision'][0] = 'État';
$GLOBALS['TL_LANG']['tl_iso_config']['subdivision'][1] = 'Veuillez entrer le nom du Département.';
$GLOBALS['TL_LANG']['tl_iso_config']['country'][0] = 'Pays';
$GLOBALS['TL_LANG']['tl_iso_config']['country'][1] = 'Sélectionner le pays.';
$GLOBALS['TL_LANG']['tl_iso_config']['phone'][0] = 'Numéro de téléphone';
$GLOBALS['TL_LANG']['tl_iso_config']['phone'][1] = 'Saisir le numéro de téléphone.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields'][0] = 'Champs d\'adresse';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields'][1] = 'Veuillez sélectionner les champs pour une adresse de facturation et d\'expédition lors de la vérification.';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['name'][0] = 'Champ d\'adresse';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['billing'][0] = 'Pour l\'adresse de facturation';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['shipping'][0] = 'Pour l\'adresse d\'expédition';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['disabled'] = 'Désactivé';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['enabled'] = 'Activé (facultatif)';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['mandatory'] = 'Activé (obligatoire)';
$GLOBALS['TL_LANG']['tl_iso_config']['billing_country'][0] = 'Billing default country';
$GLOBALS['TL_LANG']['tl_iso_config']['billing_country'][1] = 'Select a default country for new billing addresses.';
$GLOBALS['TL_LANG']['tl_iso_config']['shipping_country'][0] = 'Pays de livraison par défaut';
$GLOBALS['TL_LANG']['tl_iso_config']['shipping_country'][1] = 'Sélectionnez un pays par défaut pour les nouvelles adresses de livraison.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['currencySymbol'][0] = 'Utiliser un symbole monétaire';
$GLOBALS['TL_LANG']['tl_iso_config']['currencySymbol'][1] = 'Utiliser le symbole monétaire ($, €) si disponible.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['currencyAutomator'][0] = 'Automatic currency conversion';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyAutomator'][1] = 'Enable automatic update of price calcuation factors by using an online currency conversion provider.';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyOrigin'][0] = 'Currency origin';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyOrigin'][1] = 'Please select the source currency for calculation.';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyProvider'][0] = 'Currency Data Provider';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyProvider'][1] = 'Select an available online provider of currency calculation data.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['orderDigits'][0] = 'Order number length';
$GLOBALS['TL_LANG']['tl_iso_config']['orderDigits'][1] = 'Select the minimum length of the order number (not including order prefix).';
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_new'][0] = 'État pour les nouvelles commandes';
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_new'][1] = 'Choose a matching status for new orders. A payment module can override this.';
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_error'][0] = 'État des commandes en cas d\'erreur';
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_error'][1] = 'Sélectionnez un état de la commande en cas d\'erreur (par exemple : le paiement).';
$GLOBALS['TL_LANG']['tl_iso_config']['invoiceLogo'][0] = 'Logo des factures';
$GLOBALS['TL_LANG']['tl_iso_config']['invoiceLogo'][1] = 'Sélectionner un logo qui apparaîtra sur les factures de cette boutique.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['newProductPeriod'][0] = 'Durée pendant laquelle un produit est "nouveau"';
$GLOBALS['TL_LANG']['tl_iso_config']['newProductPeriod'][1] = 'Si vous souhaitez mettre en valeur de nouveau produits, vous pouvez entrer une durée ici. Ceci ajoutera automatiquement une classe CSS "new" à tout les produits dans Isotope eCommerce.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['edit'][0] = 'Éditer une configuration';
$GLOBALS['TL_LANG']['tl_iso_config']['edit'][1] = 'Éditer la configuration de boutique ID %s.';
$GLOBALS['TL_LANG']['tl_iso_config']['copy'][0] = 'Dupliquer une configuration';
$GLOBALS['TL_LANG']['tl_iso_config']['copy'][1] = 'Dupliquer la configuration de boutique ID %s.';
$GLOBALS['TL_LANG']['tl_iso_config']['delete'][0] = 'Supprimer une configuration';
$GLOBALS['TL_LANG']['tl_iso_config']['delete'][1] = 'Supprimer la configuration de boutique ID %s.';
$GLOBALS['TL_LANG']['tl_iso_config']['show'][0] = 'Détails de la configuration';
...
$GLOBALS['TL_LANG']['tl_iso_config']['checkout_legend'] = 'Commander';
...
$GLOBALS['TL_LANG']['tl_iso_config']['url_legend'] = 'Paramètres URL';
$GLOBALS['TL_LANG']['tl_iso_config']['products_legend'] = 'Produits';
