...
$GLOBALS['TL_LANG']['tl_iso_addresses']['label'] = array('Label', 'Veuillez, s\'il vous plaît, entrer un label personnalisé pour cette adresse.');
...
$GLOBALS['TL_LANG']['tl_iso_addresses']['subdivision'][0] = 'Etat';
