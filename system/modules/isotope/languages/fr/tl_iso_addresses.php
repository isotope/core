...
$GLOBALS['TL_LANG']['tl_iso_addresses']['label'][0] = 'Libellé';
$GLOBALS['TL_LANG']['tl_iso_addresses']['label'][1] = 'Veuillez, s\'il vous plaît, entrer un libellé personnalisé pour cette adresse.';
$GLOBALS['TL_LANG']['tl_iso_addresses']['salutation'][0] = 'Civilité';
$GLOBALS['TL_LANG']['tl_iso_addresses']['salutation'][1] = 'Veuillez, s\'il vous plaît, entrer un titre de civilité (M., Mme, Dr, Pr).';
