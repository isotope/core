...
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['note'][1] = 'Elles seront affichées en frontend  en liaison avec les options de livraison.';
...
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['label'][1] = 'Il est affiché en frontend en liaison avec l\'option de livraison.';
...
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['product_types'][1] = 'Vous pouvez limiter le mode de livraison pour certains types de produits. Si le panier contient un type de produit vous n\'avez pas sélectionné, le module d\'expédition n\'est pas disponible.';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['surcharge_field'][0] = 'Supplément de livraison';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['surcharge_field'][1] = 'Spécifiez un supplément (par exemple, une surtaxe de carburant sur toutes les commandes) à appliquer pour ce mode de livraison, le cas échéant.';
...
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_accessKey'][1] = 'Il s\'agit d\'une clé spéciale alphanumérique émise par UPS une fois que vous ouvrez un compte UPS et pour l\'accès à l\'API UPS Outils en ligne';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_developersKey'][0] = 'Clé de développeur UPS';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_developersKey'][1] = 'Il s\'agit d\'une clé spéciale alphanumérique émise par UPS une fois que vous ouvrez un compte UPS et pour l\'accès à l\'API UPS Outils en ligne';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_userName'][0] = 'Nom d\'utilisateur UPS';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_userName'][1] = 'C\'est le nom du compte que vous avez choisi lors de votre inscription sur le site de UPS.';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_password'][0] = 'Mot de passe UPS';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_password'][1] = 'C\'est le mot de passe que vous avez choisi lors de votre inscription sur le site de UPS.';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_enabledService'][0] = 'Type de service UPS';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['ups_enabledService'][1] = 'Sélectionnez un service d\'expédition UPS à offrir.';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['usps_enabledService'][0] = 'Type de service USPS';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['usps_enabledService'][1] = 'Sélectionnez un service d\'expédition USPS à offrir.';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['usps_userName'][0] = 'Nom d\'utilisateur USPS';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['usps_userName'][1] = 'C\'est le nom du compte que vous avez choisi lors de votre inscription sur le site de USPS.';
