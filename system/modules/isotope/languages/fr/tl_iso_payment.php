...
$GLOBALS['TL_LANG']['tl_iso_payment']['datatrans_hash_method'][0] = 'Méthode de hachage';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_merchantId'][1] = 'Saisir votre identifiant de commerçant (merchant ID).';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_paymentMethods'][0] = 'Modes de paiement';
$GLOBALS['TL_LANG']['tl_iso_payment']['opp_password'][0] = 'Mot de passe';
