...
$GLOBALS['TL_LANG']['tl_iso_producttypes']['prices'][1]          = 'Permet de définir plusieurs prix par produit, par exemple, pour les différentes configurations de boutique, des groupes de membres ou de dates.';
...
$GLOBALS['TL_LANG']['tl_iso_producttypes']['edit'][0]   = 'Éditer un type de produit';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['edit'][1]   = 'Éditer le type de produit ID %s';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['copy'][0]   = 'Dupliquer un type de produit';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['copy'][1]   = 'Dupliquer le type de produit ID %s';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['delete'][0] = 'Effacer un type de produit';
