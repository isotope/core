...
$GLOBALS['TL_LANG']['tl_iso_producttypes']['description'][0] = 'Description';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['attributes'][0] = 'Attributs';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['attributes'][1] = 'Sélectionner la collection d\'attributs qui doit être inclus pour ce type de produit.';
...
$GLOBALS['TL_LANG']['tl_iso_producttypes']['variant_attributes'][0] = 'Attributs des variantes';
...
$GLOBALS['TL_LANG']['tl_iso_producttypes']['edit'][0] = 'Editer le type de produit';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['edit'][1] = 'Editer le type de produit ID%s';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['copy'][0] = 'Duppliquer le type de produit';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['copy'][1] = 'Duppliquer le type de produit ID%s';
...
$GLOBALS['TL_LANG']['tl_iso_producttypes']['template_legend'] = 'Modèle';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['language_legend'] = 'Paramètres des langues';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['attributes_legend'] = 'Attributs du produit';
$GLOBALS['TL_LANG']['tl_iso_producttypes']['download_legend'] = 'Téléchargements';
