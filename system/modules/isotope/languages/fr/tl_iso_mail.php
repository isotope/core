...
$GLOBALS['TL_LANG']['tl_iso_mail']['edit'][1] = 'Editer le modèle d\'e-mail ID %s';
$GLOBALS['TL_LANG']['tl_iso_mail']['copy'][0] = 'Duppliquer le modèle d\'e-mail';
$GLOBALS['TL_LANG']['tl_iso_mail']['copy'][1] = 'Duppliquer le modèle d\'e-mail ID %s';
