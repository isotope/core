...
$GLOBALS['TL_LANG']['tl_iso_tax_class']['label'][0] = 'Inclure un libellé';
$GLOBALS['TL_LANG']['tl_iso_tax_class']['label'][1] = 'A label for orders to present for subtracted taxes (if included tax does not match). Default tax rate label will be used if this is blank.';
...
$GLOBALS['TL_LANG']['tl_iso_tax_class']['applyRoundingIncrement'][0] = 'Apply rounding increment';
$GLOBALS['TL_LANG']['tl_iso_tax_class']['applyRoundingIncrement'][1] = 'Check here if you want to apply the rounding increment of your shop config.';
$GLOBALS['TL_LANG']['tl_iso_tax_class']['notNegative'][0] = 'Non négatif';
$GLOBALS['TL_LANG']['tl_iso_tax_class']['notNegative'][1] = 'Empêche une valeur négative pour cette taxe (le montant négatif sera ajusté à 0,00).';
