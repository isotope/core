...
$GLOBALS['TL_LANG']['tl_iso_shipping_options']['name'][1] = 'Une brève description de ce taux. Utiliser en front office.';
...
$GLOBALS['TL_LANG']['tl_iso_shipping_options']['weight_from'][0] = 'Poids à partir de';
$GLOBALS['TL_LANG']['tl_iso_shipping_options']['weight_to'][0] = 'Poids jusqu\'à';
