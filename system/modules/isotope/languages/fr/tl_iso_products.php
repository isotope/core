...
$GLOBALS['TL_LANG']['tl_iso_products']['groups']                = array('Groupes de membres autorisés', 'These groups will be able to access the product.');
$GLOBALS['TL_LANG']['tl_iso_products']['guests']                = array('Visible par les invités seulement', 'Hide the product if there is an authenticated user.');
