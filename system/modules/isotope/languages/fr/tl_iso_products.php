...
$GLOBALS['TL_LANG']['tl_iso_products']['alias'][1] = 'Vous pouvez entrer un alias unique pour ce produit. Si vous ne remplissez pas le champ, il sera automatiquement généré à partir du nom.';
$GLOBALS['TL_LANG']['tl_iso_products']['name'][0] = 'Nom';
$GLOBALS['TL_LANG']['tl_iso_products']['name'][1] = 'Veuillez, s\'il vous plaît, entrer le nom de ce produit.';
$GLOBALS['TL_LANG']['tl_iso_products']['sku'][0] = 'SKU (Unité de gestion des stocks)';
$GLOBALS['TL_LANG']['tl_iso_products']['sku'][1] = 'Veuillez, s\'il vous plaît, entrer une unité de gestion des stocks unique pour ce produit.';
...
$GLOBALS['TL_LANG']['tl_iso_products']['teaser'][1] = 'Veuillez, s\'il vous plaît, entrer un résumé.';
$GLOBALS['TL_LANG']['tl_iso_products']['description'][0] = 'Description';
$GLOBALS['TL_LANG']['tl_iso_products']['description'][1] = 'Veuillez, s\'il vous plaît, entrer la description du produit.';
$GLOBALS['TL_LANG']['tl_iso_products']['price'][0] = 'Prix';
$GLOBALS['TL_LANG']['tl_iso_products']['price'][1] = 'Veuillez, s\'il vous plaît, entrer un prix pour ce produit.';
...
$GLOBALS['TL_LANG']['tl_iso_products']['baseprice'][0] = 'Prix de base';
$GLOBALS['TL_LANG']['tl_iso_products']['baseprice'][1] = 'Veuillez, s\'il vous plaît, entrer votre prix de base.';
$GLOBALS['TL_LANG']['tl_iso_products']['images'][0] = 'Images';
$GLOBALS['TL_LANG']['tl_iso_products']['images'][1] = 'Importer des images pour ce produit. Veuillez, s\'il vous plaît, sauvegarder le produit après avoir sélectionné un fichier.';
$GLOBALS['TL_LANG']['tl_iso_products']['protected'][0] = 'Protéger le produit';
$GLOBALS['TL_LANG']['tl_iso_products']['protected'][1] = 'Restreindre l\'accès du produit à certains groupes de membres.';
$GLOBALS['TL_LANG']['tl_iso_products']['groups'][0] = 'Groupes de produits';
$GLOBALS['TL_LANG']['tl_iso_products']['groups'][1] = 'Gérer les groupes de produits';
$GLOBALS['TL_LANG']['tl_iso_products']['guests'][0] = 'Visible par les invités seulement';
$GLOBALS['TL_LANG']['tl_iso_products']['guests'][1] = 'Masquer le produit s\'il y a un utilisateur authentifié.';
$GLOBALS['TL_LANG']['tl_iso_products']['cssID'][0] = 'ID / classe(s) CSS';
$GLOBALS['TL_LANG']['tl_iso_products']['cssID'][1] = 'Ici, vous pouvez ajouter un ID et une ou plusieurs classes.';
...
$GLOBALS['TL_LANG']['tl_iso_products']['mmTranslateNone'][0] = 'Non';
$GLOBALS['TL_LANG']['tl_iso_products']['mmTranslateNone'][1] = 'Ne pas traduire cette image.';
$GLOBALS['TL_LANG']['tl_iso_products']['mmTranslateText'][0] = 'Texte';
$GLOBALS['TL_LANG']['tl_iso_products']['mmTranslateText'][1] = 'Traduire le texte alternatif et la description pour cette image.';
$GLOBALS['TL_LANG']['tl_iso_products']['mmTranslateAll'][0] = 'Exclure';
$GLOBALS['TL_LANG']['tl_iso_products']['mmTranslateAll'][1] = 'Ne pas inclure cette image dans la version traduite.';
...
$GLOBALS['TL_LANG']['tl_iso_products']['toggle'][0] = 'Publier/dé-publier un produit';
$GLOBALS['TL_LANG']['tl_iso_products']['toggle'][1] = 'Publier/dé-publier le produit ID %s';
