...
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_customer_defined'][0] = 'Défini par le client';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_customer_defined'][1] = 'Merci de choisir si cette valeur doit être définie par le client (frontend).';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_order_by_enabled'][0] = 'Ajouter aux option de la liste de tri';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_be_filterable'][0] = 'Peut-être filtré en back office';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_be_searchable'][0] = 'Peut-être recherché en back office';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_be_searchable'][1] = 'Le moteur de recherche doit-il inclure ce champ?';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_filterable'][0] = 'Peut-être filtré en front office';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_filterable'][1] = 'Cet atrribut peut-il être filtré en frontend?';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_searchable'][0] = 'Peut-être recherché en front office';
$GLOBALS['TL_LANG']['tl_iso_attributes']['is_searchable'][1] = 'Le moteur de recherche doit-il inclure ce champ?';
