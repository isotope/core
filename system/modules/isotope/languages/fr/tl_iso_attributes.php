...
$GLOBALS['TL_LANG']['tl_iso_attributes']['legend'][1] = 'Select a field group that this attribute relates to (used to organize related fields into collapsible fieldset groups when editing products.';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['value'][0] = 'Valeur';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['label'][0] = 'Libellé';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['default'][0] = 'Par défaut';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['group'][0] = 'Groupe';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['rgxp'][1] = 'Validez l\'entrée avec une expression régulière.';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['files'][0] = 'Afficher les fichiers';
$GLOBALS['TL_LANG']['tl_iso_attributes']['files'][1] = 'Afficher les fichiers et dossiers.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['filesOnly'][0] = 'Files only';
$GLOBALS['TL_LANG']['tl_iso_attributes']['filesOnly'][1] = 'Remove the radio buttons or checkboxes next to folders.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['fieldType'][0] = 'Field type';
$GLOBALS['TL_LANG']['tl_iso_attributes']['fieldType'][1] = 'Display radio buttons or checkboxes next to folders.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['sortBy'][0] = 'Trier par';
$GLOBALS['TL_LANG']['tl_iso_attributes']['sortBy'][1] = 'Choisir un type de tri.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['path'][0] = 'Répertoire racine';
$GLOBALS['TL_LANG']['tl_iso_attributes']['path'][1] = 'Vous pouvez limiter l\'arborescence de fichiers en définissant un répertoire racine ici.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['storeFile'][0] = 'Enregistrer les fichiers envoyés';
$GLOBALS['TL_LANG']['tl_iso_attributes']['storeFile'][1] = 'Envoyer les fichiers dans un dossier sur le serveur.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['uploadFolder'][0] = 'Dossier de destination';
$GLOBALS['TL_LANG']['tl_iso_attributes']['uploadFolder'][1] = 'Veuillez, s\'il vous plaît, choisir le dossier de destination dans l\'arborescence de fichiers.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['useHomeDir'][0] = 'Utiliser le répertoire personnel';
$GLOBALS['TL_LANG']['tl_iso_attributes']['useHomeDir'][1] = 'Enregistrer le fichier dans le répertoire personnel si l\'utilisateur est authentifié.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['doNotOverwrite'][0] = 'Conserver les fichiers existants';
$GLOBALS['TL_LANG']['tl_iso_attributes']['doNotOverwrite'][1] = 'Ajouter un suffixe numérique au nouveau fichier si le nom de fichier existe déjà.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['fe_sorting'][0] = 'Add to "Order By" option list';
$GLOBALS['TL_LANG']['tl_iso_attributes']['fe_sorting'][1] = 'This field will be sortable in the listing module provided the attribute is visible to customers.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['be_filter'][0] = 'Peut être filtré en back office';
$GLOBALS['TL_LANG']['tl_iso_attributes']['be_filter'][1] = 'Cet attribut peut-il être filtré en back office ?';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['fe_filter'][1] = 'Cet attribut peut-il être filtré en front office ?';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['extnd'][1] = 'Permet tout sauf les caractères spéciaux qui sont généralement encodés pour des raisons de sécurité (#/()<=>).';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['name_asc'] = 'Nom de fichier (ascendant)';
$GLOBALS['TL_LANG']['tl_iso_attributes']['name_desc'] = 'Nom de fichier (descendant)';
$GLOBALS['TL_LANG']['tl_iso_attributes']['date_asc'] = 'Date (ascendant)';
$GLOBALS['TL_LANG']['tl_iso_attributes']['date_desc'] = 'Date (descendant)';
$GLOBALS['TL_LANG']['tl_iso_attributes']['random'] = 'Ordre aléatoire';
$GLOBALS['TL_LANG']['tl_iso_attributes']['new'][0] = 'Nouvel attribut';
$GLOBALS['TL_LANG']['tl_iso_attributes']['new'][1] = 'Créer un nouvel attribut';
$GLOBALS['TL_LANG']['tl_iso_attributes']['edit'][0] = 'Éditer un attribut';
$GLOBALS['TL_LANG']['tl_iso_attributes']['edit'][1] = 'Éditer l\'attribut ID %s.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['copy'][0] = 'Dupliquer un attribut';
$GLOBALS['TL_LANG']['tl_iso_attributes']['copy'][1] = 'Dupliquer l\'attribut ID %s.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['delete'][0] = 'Supprimer un attribut';
