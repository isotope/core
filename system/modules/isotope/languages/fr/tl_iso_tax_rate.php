...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['postalCodes'][0] = 'Codes postaux';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['postalCodes'][1] = 'Limiter le taux de taxe à certain code postaux. Vous pouvez utiliser une liste séparée par des virgules et des portée (ex: 1234,1235,1236-1239,1100-1200).';
...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['config'][0] = 'Configuration de la boutique';
...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['groups'][0] = 'Groupes de membres';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['groups'][1] = 'Restreindre ce taux de taxe à certain groupes de membres';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['protected'][0] = 'Protéger le taux de taxe';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['protected'][1] = 'Appliquer le taux de taxe à certain groupes de membre seulement.';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['guests'][0] = 'Appliquer aux invités seulement';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['guests'][1] = 'Ne pas appliquer le taux de taxe si un membre est connecté.';
