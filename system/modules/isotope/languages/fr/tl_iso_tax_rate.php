...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['country'][0] = 'Pays';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['country'][1] = 'Sélectionner le pays auquel s\'applique ce taux de taxe.';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['subdivision'][0] = 'Etat / Département';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['subdivision'][1] = 'Sélectionner un état ou un département auquel s\'applique ce taux de taxe.';
...
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['edit'][0] = 'Éditer le taux de taxe';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['edit'][1] = 'Éditer le taux de taxe ID %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['copy'][0] = 'Duppliquer taux de taxe';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['copy'][1] = 'Duppliquer le taux de taxe ID %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['delete'][0] = 'Supprimer le taux de taxe ID %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['delete'][1] = 'Supprimer le taux de taxe ID %s';
$GLOBALS['TL_LANG']['tl_iso_tax_rate']['show'][0] = 'Afficher les détails du taux de taxe';
