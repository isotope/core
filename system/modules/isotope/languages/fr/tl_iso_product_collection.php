...
$GLOBALS['TL_LANG']['tl_iso_product_collection']['date_shipped'][1] = 'Saisir la date à laquelle la commande a été livrée.';
...
$GLOBALS['TL_LANG']['tl_iso_product_collection']['edit'][1] = 'Éditer la commande ID %s';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['copy'][0] = 'Dupliquer une commande';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['copy'][1] = 'Dupliquer la commande ID %s';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['delete'][0] = 'Supprimer une commande';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['delete'][1] = 'Supprimer la commande ID %s';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['show'][0] = 'Détails de la commande';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['show'][1] = 'Afficher les détails de la commande ID %s';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['payment'][0] = 'Payment details';
...
$GLOBALS['TL_LANG']['tl_iso_product_collection']['print_document'][1] = 'Imprimer commande ID %s avec un document de votre choix';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['document_choice'][0] = 'Document';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['document_choice'][1] = 'Choisissez le Document avec lequel vous souhaitez imprimer les données.';
...
$GLOBALS['TL_LANG']['tl_iso_product_collection']['orderStatusNotificationSuccess'] = 'Notifications (ex: email au client) ont été envoyés.';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['orderStatusNotificationError'] = 'Notifications (ex: courriel au client) n\'ont pas pu être envoyés. Vérifiez le log du système';
$GLOBALS['TL_LANG']['tl_iso_product_collection']['status_legend'] = 'État des commandes';
