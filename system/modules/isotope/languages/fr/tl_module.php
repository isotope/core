...
$GLOBALS['TL_LANG']['tl_module']['iso_reader_jumpTo'][0]          = 'Aller à la page des détails d\'un produit';
$GLOBALS['TL_LANG']['tl_module']['iso_reader_jumpTo'][1]          = 'Ce paramètre définit la page à laquelle l\'utilisateur sera redirigé en cliquant sur un produit pour plus d\'informations (<strong>Remarque : </strong>cela remplace les paramètres définis dans la structure du site).';
...
$GLOBALS['TL_LANG']['tl_module']['iso_emptyMessage']              = array('Message personnalisé quand il n\'y a rien à afficher', 'Définir un message personnalisé quand il n\'y a rien à afficher (liste de produit vide, panier vide, etc.)');
