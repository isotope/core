...
$GLOBALS['TL_LANG']['tl_module']['listing_filters'][0] = 'Filtres de liste';
$GLOBALS['TL_LANG']['tl_module']['listing_filters'][1] = 'Sélectionner un ou plusieurs filtres à inclure dans la zone de module.';
...
$GLOBALS['TL_LANG']['tl_module']['iso_addToAddressbook'][0] = 'Ajouter au carnet d\'adresse';
...
$GLOBALS['TL_LANG']['tl_module']['iso_orderByFields'][0] = 'Activer les champs de tri';
$GLOBALS['TL_LANG']['tl_module']['iso_orderByFields'][1] = 'Sélectionner les champs de tri à activer.';
...
$GLOBALS['TL_LANG']['tl_module']['iso_listingModule'][0] = 'Module liste';
$GLOBALS['TL_LANG']['tl_module']['iso_listingModule'][1] = 'choisir un module liste avec lequel ce module filtre va fonctionner.';
$GLOBALS['TL_LANG']['tl_module']['iso_enableSearch'][0] = 'Activer la recherche';
$GLOBALS['TL_LANG']['tl_module']['iso_enableSearch'][1] = 'Cocher cette case pour activer la recherche de produits.';
