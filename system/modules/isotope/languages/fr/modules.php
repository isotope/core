...
$GLOBALS['TL_LANG']['MOD']['iso_orders'][1] = 'Voir et gérer les commandes de votre boutique';
$GLOBALS['TL_LANG']['MOD']['iso_setup'][0] = 'Configuration de la boutique';
$GLOBALS['TL_LANG']['MOD']['iso_setup'][1] = 'Installer et configurer Isotope eCommerce à vos besoins';
...
$GLOBALS['TL_LANG']['FMD']['iso_cumulativefilter'][0] = 'Cumulative Filter';
$GLOBALS['TL_LANG']['FMD']['iso_cumulativefilter'][1] = 'Provides a cumulative filter so visitors can cut down the product choice by clicking on multiple conditions.';
...
$GLOBALS['TL_LANG']['FMD']['iso_messages'][0] = 'Messages';
$GLOBALS['TL_LANG']['FMD']['iso_messages'][1] = 'Affiche tous les messages d\'Isotopes s\'ils n\'ont pas été affichés ailleurs.';
$GLOBALS['TL_LANG']['IMD']['config_module'] = 'Configuration du eCommerce Isotope (Version : %s)';
...
$GLOBALS['TL_LANG']['IMD']['gallery'][0] = 'Galeries';
$GLOBALS['TL_LANG']['IMD']['gallery'][1] = 'Définir comment les images de votre produit seront rendues.';
$GLOBALS['TL_LANG']['IMD']['baseprice'][0] = 'Prix de base';
$GLOBALS['TL_LANG']['IMD']['baseprice'][1] = 'Définir les prix de base.';
...
$GLOBALS['TL_LANG']['IMD']['notifications'][0] = 'Notifications';
$GLOBALS['TL_LANG']['IMD']['notifications'][1] = 'Utiliser le Centre de Notification pour gérer les emails, etc. pour Isotope eCommerce.';
$GLOBALS['TL_LANG']['IMD']['documents'][0] = 'Documents';
$GLOBALS['TL_LANG']['IMD']['documents'][1] = 'Définir des documents.';
$GLOBALS['TL_LANG']['IMD']['miscellaneous'] = 'Divers';
$GLOBALS['TL_LANG']['IMD']['labels'][0] = 'Traductions';
$GLOBALS['TL_LANG']['IMD']['labels'][1] = 'Remplacez les libellés fournis pour certaines langues.';
