...
$GLOBALS['TL_LANG']['MSC']['pay_with_redirect'][1] = 'Zostaniesz przekierowany na strony systemu płatności. Jeśli nie jesteś automatycznie przekierowany, kliknij przycisk "Zapłać teraz".';
...
$GLOBALS['TL_LANG']['WGT']['mg'][0] = 'Miligram (mg)';
$GLOBALS['TL_LANG']['WGT']['mg'][1] = 'Jednostka masy równa jednej tysięcznej grama.';
$GLOBALS['TL_LANG']['WGT']['g'][0] = 'Gram (g)';
$GLOBALS['TL_LANG']['WGT']['g'][1] = 'Jednostka masy równa jednej tysięcznej kilograma.';
$GLOBALS['TL_LANG']['WGT']['kg'][0] = 'Kilogram (kg)';
$GLOBALS['TL_LANG']['WGT']['kg'][1] = 'Jeden kilogram jest równy 1,000 gramom lub 2.2 funta; masa jednego litra wody.';
$GLOBALS['TL_LANG']['WGT']['t'][0] = 'Tona (t)';
$GLOBALS['TL_LANG']['WGT']['t'][1] = 'Jednostka masy równa 1,000 kilogramom lub 2,204.6 funtom.';
$GLOBALS['TL_LANG']['WGT']['ct'][0] = 'Karaty (ct)';
$GLOBALS['TL_LANG']['WGT']['ct'][1] = 'Jednostka miary używana dla kamieni szlachetnych. Jeden karat jest równy 1/5 grama (200 miligram). Zauważ, że karat z "K" jest miarą czystości stopu złota.';
$GLOBALS['TL_LANG']['WGT']['oz'][0] = 'Uncja (oz)';
$GLOBALS['TL_LANG']['WGT']['oz'][1] = 'Jednostka masy równa jednej szesnastej funta lub 28.35 gramów.';
$GLOBALS['TL_LANG']['WGT']['lb'][0] = 'Funt (lb)';
$GLOBALS['TL_LANG']['WGT']['lb'][1] = 'Jednostka masy równa 16 uncjom.';
$GLOBALS['TL_LANG']['WGT']['st'][0] = 'Kamień (st)';
$GLOBALS['TL_LANG']['WGT']['st'][1] = 'Brytyjska jednostka masy równa 14 funtom.';
$GLOBALS['TL_LANG']['WGT']['grain'][0] = 'Ziarno';
$GLOBALS['TL_LANG']['WGT']['grain'][1] = '1/7000 funta; równa się 64.799 miligramów.';
