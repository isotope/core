...
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['paid'][1] = 'Zamówienie jest opłacone jeśli ma ten status. Pozwoli to na przykład na ściągnięcie plików.';
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['welcomescreen'][0] = 'Pokaż na ekranie powitania';
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['welcomescreen'][1] = 'Pokaż liczbę zamówień z tym statusem na stronie powitalnej panelu administratora.';
...
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['cut'][0] = 'Przenieś status zamówienia';
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['cut'][1] = 'Przenieś status zamówienia ID %s';
