...
$GLOBALS['TL_LANG']['MOD']['iso_products']				= array('Produkte', 'Verwalten Sie Produkte und Produkt-Varianten.');
$GLOBALS['TL_LANG']['MOD']['iso_orders']				= array('Bestellungen', 'Alle Bestellungen in Ihrem Online-Shop sind hier ersichtlich.');
$GLOBALS['TL_LANG']['MOD']['iso_statistics']			= array('Verkaufsstatistik', '');
$GLOBALS['TL_LANG']['MOD']['iso_setup']					= array('Shop-Konfiguration', 'Hier können Sie Isotope eCommerce konfigurieren.');
...
$GLOBALS['TL_LANG']['IMD']['producttypes']				= array('Produkttypen', 'Mittels Produkttypen können Sie Ihre Produkte gruppieren. Verschiedene Produttypen können verschiedene Felder und Funktionen (z.B. Downloads aktiveren) enthalten.');
$GLOBALS['TL_LANG']['IMD']['attributes']				= array('Attribute', 'In der Attributverewaltung können Sie eigene Felder für Ihre Produkte anlegen. Dies ist z.B. hilfreich wenn Ihr Produkt einen Untertitel haben soll. Beachten Sie dass die entsprechenden Felder dann manuell im Template ausgegeben werden müssen (=Template-Anpassung).');
$GLOBALS['TL_LANG']['IMD']['related_categories']		= array('Verknüpfte Kategorien', 'Legen Sie hier Kategorien an, mit deren Gruppierung Sie später Produkte miteinander verknüpfen können.');
