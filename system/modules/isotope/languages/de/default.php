...
$GLOBALS['TL_LANG']['ERR']['cumulativeDuplicateAttribute'] = 'Das gleiche Attribut kann nicht mehrmals konfiguriert werden.';
...
$GLOBALS['TL_LANG']['MSC']['iso_order_description'] = 'Beschreibung';
$GLOBALS['TL_LANG']['MSC']['iso_order_quantity'] = 'Anzahl';
$GLOBALS['TL_LANG']['MSC']['iso_order_price'] = 'Preis';
...
$GLOBALS['TL_LANG']['MSC']['pay_with_redirect'][1] = 'Sie werden auf die Website des Zahlungsanbieters weitergeleitet.';
$GLOBALS['TL_LANG']['MSC']['pay_with_redirect'][2] = 'Bezahlen';
$GLOBALS['TL_LANG']['MSC']['pay_with_redirect'][3] = 'Bitte klicken Sie auf „Jetzt bezahlen“ um fortzufahren.';
...
$GLOBALS['TL_LANG']['MSC']['noShippingAddress'] = 'Bitte geben Sie eine Lieferadresse ein.';
$GLOBALS['TL_LANG']['MSC']['noShippingRequiredMsg'] = 'Keines der Produkte in Ihrem Warenkorb muss geliefert werden.';
$GLOBALS['TL_LANG']['MSC']['availableShippingMethodsMsg'] = 'Folgende Versandarten sind für Ihren aktuellen Warenkorb und Ihre angegebene Versandadresse verfügbar:';
$GLOBALS['TL_LANG']['MSC']['saveAddressButton'] = 'Adresse speichern';
...
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment']['paybyway'][0] = 'Paybyway';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment']['paybyway'][1] = 'Fügt den Zahlungsanbieter <a href="https://www.paybyway.com/en/" target="_blank">Paybyway</a> hinzu.';
...
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment']['epay'][0] = 'ePay';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment']['epay'][1] = 'Fügt den Zahlungsanbieter <a href="http://www.epay.eu" target="_blank">ePay</a> hinzu.';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment']['payone'][0] = 'PayOne';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment']['worldpay'][0] = 'WorldPay';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment']['quickpay'][0] = 'QuickPay';
...
$GLOBALS['TL_LANG']['MODEL']['tl_iso_gallery']['elevatezoom'][0] = 'Elevate zoom Galerie';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_gallery']['elevatezoom'][1] = 'Eine Galerie, bei der beim Mouseover im Bild gezoomt wird. Mehr Infos auf der <a href="http://www.elevateweb.co.uk/image-zoom" target="_blank">Skript-Website</a>.';
...
$GLOBALS['TL_LANG']['ATTR']['media'][0] = 'Video/Audio';
$GLOBALS['TL_LANG']['ATTR']['media'][1] = 'Erzeugt einen Video- oder Audio-Player.';
