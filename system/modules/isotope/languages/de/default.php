 ...
 * Shipping modules
 */
$GLOBALS['ISO_LANG']['SHIP']['collection']  = array('Abholung');
$GLOBALS['ISO_LANG']['SHIP']['order_total'] = array('Order total-based shipping');
$GLOBALS['ISO_LANG']['SHIP']['flat']        = array('Pauschalversand');
 ...
 * Payment modules
 */
$GLOBALS['ISO_LANG']['PAY']['cash']              = array('Barzahlung', 'Wählen Sie dies für alle offline Bezahlmethoden.');
$GLOBALS['ISO_LANG']['PAY']['paypal']            = array('PayPal Standard', 'Dieses PayPal-Modul unterstützt die "Sofortige Zahlungsbestätigung" (IPN).');
$GLOBALS['ISO_LANG']['PAY']['paypalpro']         = array('PayPal Website Payments Pro', 'This PayPal module is a full service credit card gateway using Paypals own Website Payments Pro gateway.  Recommended only for low-traffic situations with no transactions over $10,000.');
...
$GLOBALS['ISO_LANG']['PAY']['postfinance']       = array('Postfinance (Schweizerische Post)', 'Schnittstelle des Bezahlsystems der Schweizerischen Post. Unterstützt verschiedene Karten. Der Shop wird sofort über erfolgreiche Transaktionen informiert.');


/**
 * Product types
 */
$GLOBALS['ISO_LANG']['PRODUCT']['regular'] = array('Normales Produkt', 'Ein Standard-Produkt. Wähle dieses, wenn sonst keins zutrifft.');
...
$GLOBALS['ISO_LANG']['CUR']['CDF'] = 'CDF - Kongo-Franc';
...
$GLOBALS['ISO_LANG']['CUR']['COU'] = 'COU - Unidad de Valor real';
$GLOBALS['ISO_LANG']['CUR']['CRC'] = 'CRC - Costa-Rica-Colón';
$GLOBALS['ISO_LANG']['CUR']['CUC'] = 'CUC - konvertibler Peso';
...
$GLOBALS['ISO_LANG']['CUR']['GGP'] = 'GGP - Guernsey-Pfund';
...
$GLOBALS['ISO_LANG']['CUR']['IMP'] = 'IMP - Isle of Man-Pfund';
...
$GLOBALS['ISO_LANG']['CUR']['JEP'] = 'JEP - Jersey-Pfund';
...
$GLOBALS['ISO_LANG']['CUR']['MXN'] = 'MXN - mexikanischer Peso';
...
$GLOBALS['ISO_LANG']['CUR']['NIO'] = 'NIO - Córdoba';
...
$GLOBALS['ISO_LANG']['CUR']['SVC'] = 'SVC - El-Salvador-Colón';
...
$GLOBALS['ISO_LANG']['CUR']['XAF'] = 'XAF - CFA-Franc (BEAC)';
$GLOBALS['ISO_LANG']['CUR']['XCD'] = 'XCD - ostkaribischer Dollar';
$GLOBALS['ISO_LANG']['CUR']['XOF'] = 'XOF - CFA-Franc (BCEAO)';
$GLOBALS['ISO_LANG']['CUR']['XPF'] = 'XPF - CFP-Franc';
