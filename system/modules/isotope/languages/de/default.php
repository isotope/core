...
$GLOBALS['ISO_LANG']['MSC']['activeStep'] = 'Aktueller Schritt: ';
$GLOBALS['ISO_LANG']['MSC']['productcacheLoading'] = 'Produkte werden geladen...';
$GLOBALS['ISO_LANG']['MSC']['productcacheNoscript'] = 'Ihr Browser unterstützt kein JavasScript. <a href="%s">Klicken Sie hier</a> um die Produktliste zu laden.';
$GLOBALS['ISO_LANG']['MSC']['noFilesInFolder'] = 'Keine Dateien in diesem Ordner';
