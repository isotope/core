...
$GLOBALS['TL_LANG']['MSC']['shipping_method_message'] = 'Wählen Sie eine Versandmethode aus.';
$GLOBALS['TL_LANG']['MSC']['shipping_method_missing'] = 'Bitte wählen Sie eine Versandmethode.';
...
$GLOBALS['TL_LANG']['MSC']['shipping_method'] = 'Versandmethode';
$GLOBALS['TL_LANG']['MSC']['payment_method'] = 'Bezahlmethode';
$GLOBALS['TL_LANG']['MSC']['order_review'] = 'Bestellübersicht';
...
$GLOBALS['TL_LANG']['MSC']['isotopeIntroduction'][2] = 'Auf dieser Seite werden die meisten Einstellungen vorgenommen. <u>Sie sollten am Ende der Seite starten und sich Schritt für Schritt nach oben arbeiten.</u>';
...
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['cash'][0] = 'Barzahlung';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['cash'][1] = 'Benutzen Sie dies für alle persönlich-abgewickelten Bezahlungen.';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['paypal'][0] = 'PayPal Standard Checkout';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['paypal'][1] = 'Dieses PayPal-Modul unterstützt IPN (Instant Payment Notifications).';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['postfinance'][0] = 'PostFinance';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['postfinance'][1] = 'Bezahlschnittstelle für das schweizer Post-Bezahlsystem welches verschiedene Kartentypen unterstützt. Der Shop wird sofort über alle erfolgreichen Transaktionen informiert.';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['datatrans'][0] = 'Datatrans';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['datatrans'][1] = 'Ein Bezahlmodul für die schweizer Bezahlschnittstelle "Datatrans".';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['sparkasse'][0] = 'Sparkasse';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['saferpay'][0] = 'Saferpay';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['sofortueberweisung'][0] = 'sofortüberweisung.de';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['expercash'][0] = 'ExperCash';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['payone'][0] = 'PayOne';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment_modules']['worldpay'][0] = 'WorldPay';
...
$GLOBALS['TL_LANG']['MODEL']['tl_iso_products']['standard'][0] = 'Standard-Produkt';
$GLOBALS['TL_LANG']['MODEL']['tl_iso_products']['standard'][1] = 'Wählen Sie das Standard-Produkt wenn kein anderes zutrifft.';
...
$GLOBALS['TL_LANG']['WGT']['mg'][0] = 'Milligramm (mg)';
$GLOBALS['TL_LANG']['WGT']['mg'][1] = 'Eine Gewichtseinheit welches einem tausendstel Gramm entspricht.';
$GLOBALS['TL_LANG']['WGT']['g'][0] = 'Gramm (g)';
$GLOBALS['TL_LANG']['WGT']['g'][1] = 'Eine metrische Gewichtsangabe welche einem tausendstel Kilogramm entspricht.';
$GLOBALS['TL_LANG']['WGT']['kg'][0] = 'Kilogramm (kg)';
$GLOBALS['TL_LANG']['WGT']['kg'][1] = 'Ein Kilogramm entspricht 1.000 Gramm oder 2.2 Pfund; Das Gewicht von einem Liter Wasser.';
$GLOBALS['TL_LANG']['WGT']['t'][0] = 'Tonne (t)';
$GLOBALS['TL_LANG']['WGT']['t'][1] = 'Eine Gewichtseinheit welche 1.000 Kilogramm oder 2.204,6 Pfund entspricht.';
$GLOBALS['TL_LANG']['WGT']['ct'][0] = 'Karat (ct)';
$GLOBALS['TL_LANG']['WGT']['ct'][1] = 'Eine Maßeinheit welche für Edelsteine verwendet wird. Ein Karat entspricht 1/5 eines Grammes (200 Milligramm). Bitte verwechseln Sie dies nicht mit den Karat für die Messung von Gold.';
$GLOBALS['TL_LANG']['WGT']['oz'][0] = 'Unze (oz)';
$GLOBALS['TL_LANG']['WGT']['oz'][1] = 'Eine Gewichtseinheit welche ein sechzehntel eines Pfundes oder 28,35 Gramm entsprechen.';
$GLOBALS['TL_LANG']['WGT']['lb'][0] = 'Pfund (lb)';
$GLOBALS['TL_LANG']['WGT']['lb'][1] = 'Eine Gewichtseinheit welche 16 Unzen entspricht';
$GLOBALS['TL_LANG']['WGT']['st'][0] = 'Stein (st)';
$GLOBALS['TL_LANG']['WGT']['st'][1] = 'Eine britische Mengenangabe welche 14 Pfund entspricht.';
$GLOBALS['TL_LANG']['WGT']['grain'][0] = 'Gran';
$GLOBALS['TL_LANG']['WGT']['grain'][1] = '1/7000 Pfund; Entspricht einem Troy-Gran oder 64,799 Milligramm.';
