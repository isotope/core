...
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['saferpay_status'][1] = 'Bitte wählen Sie eine Option, wenn das Zahlungs-Gateway automatisch aktualisiert werden soll. Funktioniert nur, wenn der Kunde „Saferpay“ oder „Billpay for Saferpay“ schon als Zahlungsmethode verwendet hatte.';
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['saferpay_status']['capture'] = 'Zahlung erfassen';
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['saferpay_status']['cancel'] = 'Manuelle Zahlungsstornierung vorschlagen';
...
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['email_legend'] = 'Benachrichtigung';
$GLOBALS['TL_LANG']['tl_iso_orderstatus']['payment_legend'] = 'Zahlungs-Gateways';
