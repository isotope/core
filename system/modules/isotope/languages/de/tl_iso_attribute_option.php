...
$GLOBALS['TL_LANG']['tl_iso_attribute_option']['label'][1] = 'Geben Sie die Bezeichnung für diese Auswahl ein.';
$GLOBALS['TL_LANG']['tl_iso_attribute_option']['price'][0] = 'Preisaufschläge oder -abschläge';
$GLOBALS['TL_LANG']['tl_iso_attribute_option']['price'][1] = 'Sie können einen positiven oder negativen Wert eingeben, um den Produkt-Preis bei Auswahl dieser Option zu ändern.';
