...
$GLOBALS['TL_LANG']['tl_iso_config']['currencyAutomator']               = array('Automatischer Währungsrechner', 'Automatische Updates von Preisberechnungsfaktoren durch Anbieter von online Währungsrechnern ermöglichen.');
$GLOBALS['TL_LANG']['tl_iso_config']['currencyOrigin']                  = array('Herkunftswährung', 'Bitte wählen Sie die Währung für die Berechnung aus.');
$GLOBALS['TL_LANG']['tl_iso_config']['currencyProvider']                = array('Anbieter der Währungsdaten', 'Bitte wählen Sie einer der verfügbaren Anbieter von online Währungsdaten aus.');
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_new']                 = array('Status für neue Bestellungen', 'Wählen Sie einen passenden Status für neue Bestellungen aus. Ein Zahlungsmodul kann diese Angaben überschreiben.');
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_error']               = array('Bestellstatus bei einem Fehler', 'Wählen Sie einen Status für fehlgeschlagene Bestellungen aus (z.B. Zahlung).');
...
$GLOBALS['TL_LANG']['tl_iso_config']['shipping_country']                = array('Standard Versandland', 'Wählen Sie das Standard-Land für neue Versandadressen.');
...
$GLOBALS['TL_LANG']['tl_iso_config']['billing_country']                 = array('Standard Rechnungsland', 'Wählen Sie das Standard-Land für neue Rechnungsadressen.');
...
$GLOBALS['TL_LANG']['tl_iso_config']['imageSizes'][1]                   = 'Sie können individuelle Bildgrößen für die Benutzung in Ihren Templates anlegen. Die Standardgrößen sind "gallery", "thumbnail", "medium" und "large".';
