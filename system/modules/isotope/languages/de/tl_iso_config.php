...
$GLOBALS['TL_LANG']['tl_iso_config']['vat_no'][0] = 'USt-IdNr.';
$GLOBALS['TL_LANG']['tl_iso_config']['vat_no'][1] = 'Bitte geben Sie Ihre Umsatzsteuer-Identifikationsnummer ein.';
$GLOBALS['TL_LANG']['tl_iso_config']['street_1'][0] = 'Straße';
$GLOBALS['TL_LANG']['tl_iso_config']['street_1'][1] = 'Bitte geben Sie den Straßennamen und die Hausnummer ein.';
$GLOBALS['TL_LANG']['tl_iso_config']['street_2'][0] = 'Straße 2';
$GLOBALS['TL_LANG']['tl_iso_config']['street_2'][1] = 'Geben Sie eine zweite Zeile für die Straße ein falls nötig.';
$GLOBALS['TL_LANG']['tl_iso_config']['street_3'][0] = 'Straße 3';
$GLOBALS['TL_LANG']['tl_iso_config']['street_3'][1] = 'Geben Sie eine dritte Zeile für die Straße ein falls nötig.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['city'][1] = 'Bitte geben Sie den Namen der Stadt ein.';
$GLOBALS['TL_LANG']['tl_iso_config']['subdivision'][0] = 'Staat';
$GLOBALS['TL_LANG']['tl_iso_config']['subdivision'][1] = 'Bitte geben Sie den Namen des Bundeslandes/Kanton ein.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields'][0] = 'Adressfelder';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields'][1] = 'Wählen Sie die Felder für die Rechnungs- und Versandadresse beim bezahlen aus.';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['name'][0] = 'Adressfeld';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['billing'][0] = 'Für Rechnungs-Adresse';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['shipping'][0] = 'Für Versand-Adresse';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['disabled'] = 'Deaktiviert';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['enabled'] = 'Aktiviert (Nicht verpflichtend)';
$GLOBALS['TL_LANG']['tl_iso_config']['address_fields']['mandatory'] = 'Aktiviert (Verpflichtend)';
$GLOBALS['TL_LANG']['tl_iso_config']['billing_country'][0] = 'Standard Rechnungsland';
$GLOBALS['TL_LANG']['tl_iso_config']['billing_country'][1] = 'Wählen Sie das Standard-Land für neue Rechnungsadressen.';
$GLOBALS['TL_LANG']['tl_iso_config']['shipping_country'][0] = 'Standard Versandland';
$GLOBALS['TL_LANG']['tl_iso_config']['shipping_country'][1] = 'Wählen Sie das Standard-Land für neue Versandadressen.';
$GLOBALS['TL_LANG']['tl_iso_config']['billing_countries'][0] = 'Rechnungs-Länder';
$GLOBALS['TL_LANG']['tl_iso_config']['billing_countries'][1] = 'Wählen Sie die Länder, welche beim Bestellvorgang als Rechnungs-Adressen erlaubt sind.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['currencyFormat'][0] = 'Währungs-Formatierung';
...
$GLOBALS['TL_LANG']['tl_iso_config']['currencyAutomator'][0] = 'Automatischer Währungsrechner';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyAutomator'][1] = 'Automatische Updates von Preisberechnungsfaktoren durch Anbieter von online Währungsrechnern ermöglichen.';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyOrigin'][0] = 'Herkunftswährung';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyOrigin'][1] = 'Bitte wählen Sie die Währung für die Berechnung aus.';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyProvider'][0] = 'Anbieter der Währungsdaten';
$GLOBALS['TL_LANG']['tl_iso_config']['currencyProvider'][1] = 'Bitte wählen Sie einer der verfügbaren Anbieter von online Währungsdaten aus.';
...
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_new'][0] = 'Status für neue Bestellungen';
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_new'][1] = 'Wählen Sie einen passenden Status für neue Bestellungen aus. Ein Zahlungsmodul kann diese Angaben überschreiben.';
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_error'][0] = 'Bestellstatus bei einem Fehler';
$GLOBALS['TL_LANG']['tl_iso_config']['orderstatus_error'][1] = 'Wählen Sie einen Status für fehlgeschlagene Bestellungen aus (z.B. Zahlung).';
...
$GLOBALS['TL_LANG']['tl_iso_config']['cartMinSubtotal'][0] = 'Mindestbetrag Zwischensumme';
...
$GLOBALS['TL_LANG']['tl_iso_config']['iwName'][0] = 'Name';
$GLOBALS['TL_LANG']['tl_iso_config']['iwWidth'][0] = 'Breite';
$GLOBALS['TL_LANG']['tl_iso_config']['iwHeight'][0] = 'Höhe';
$GLOBALS['TL_LANG']['tl_iso_config']['iwMode'][0] = 'Modus';
$GLOBALS['TL_LANG']['tl_iso_config']['iwWatermark'][0] = 'Wasserzeichen-Bild';
