...
$GLOBALS['TL_LANG']['tl_iso_group']['copy'][1] = 'Produktgruppe ID %s duplizieren';
$GLOBALS['TL_LANG']['tl_iso_group']['copyChilds'][0] = 'Mit Untergruppen duplizieren';
$GLOBALS['TL_LANG']['tl_iso_group']['copyChilds'][1] = 'Dupliziere Gruppe mit ID %s mit Untergruppen';
$GLOBALS['TL_LANG']['tl_iso_group']['cut'][0] = 'Gruppe verschieben';
$GLOBALS['TL_LANG']['tl_iso_group']['cut'][1] = 'Produktgruppe ID %s verschieben';
$GLOBALS['TL_LANG']['tl_iso_group']['delete'][0] = 'Gruppe löschen';
$GLOBALS['TL_LANG']['tl_iso_group']['delete'][1] = 'Produktgruppep ID %s löschen';
$GLOBALS['TL_LANG']['tl_iso_group']['show'][0] = 'Gruppendetails';
$GLOBALS['TL_LANG']['tl_iso_group']['show'][1] = 'Details der Produktgruppe ID %s anzeigen';
$GLOBALS['TL_LANG']['tl_iso_group']['pasteafter'][0] = 'Danach einfügen';
