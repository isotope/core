...
$GLOBALS['TL_LANG']['tl_iso_payment']['minimum_quantity'][1] = 'Geben Sie eine Zahl größer als 0 ein, um diese Zahlungsart bei Bestellungen mit niedrigerer Menge auszuschließen.';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['product_types_condition'][0] = 'Produkttyp-Bedingungen';
$GLOBALS['TL_LANG']['tl_iso_payment']['product_types_condition'][1] = 'Wählen Sie aus, wie der Produkttyp-Filter angewandt werden soll.';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['paybyway_merchant_id'][0] = 'Händler-ID';
$GLOBALS['TL_LANG']['tl_iso_payment']['paybyway_merchant_id'][1] = 'Bitte geben Sie Ihre Paybyway Händer-ID ein. Die Unterhändler-ID ist auf der Unterhändler-Seite der Händler-Oberfläche aufgelistet.';
$GLOBALS['TL_LANG']['tl_iso_payment']['paybyway_private_key'][0] = 'Privater Schlüssel';
$GLOBALS['TL_LANG']['tl_iso_payment']['paybyway_private_key'][1] = 'Bitte geben Sie den privaten Paybyway-Schlüssel ein.';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['psp_payment_method'][1] = 'Sie können hier eine Zahlungsart auswählen. Stellen Sie sicher, dass Ihr PSP-Vertrag diese Zahlungsart auch beinhaltet! Wenn Sie nichts auswählen, muss der Kunde die bevorzugte Zahlungsart in der PSP-Oberfläche auswählen.';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['datatrans_hash_method'][0] = 'Hash-Methode';
$GLOBALS['TL_LANG']['tl_iso_payment']['datatrans_hash_method'][1] = 'Hash-Algorithmus für Datentransfer von und zu Servern.';
$GLOBALS['TL_LANG']['tl_iso_payment']['datatrans_hash_convert'][0] = 'HMAC Schlüssel konvertieren';
$GLOBALS['TL_LANG']['tl_iso_payment']['datatrans_hash_convert'][1] = 'Wählen Sie diese Option wenn der HMAC Schlüssel vor Gebrauch in Bytes konvertiert werden soll.';
$GLOBALS['TL_LANG']['tl_iso_payment']['vads_site_id'][0] = 'Seiten-Identifikation';
$GLOBALS['TL_LANG']['tl_iso_payment']['vads_site_id'][1] = 'Geben Sie die Identifikation der Zahlungsseite ein.';
$GLOBALS['TL_LANG']['tl_iso_payment']['vads_certificate'][0] = 'Zertifikat';
$GLOBALS['TL_LANG']['tl_iso_payment']['vads_certificate'][1] = 'Bitte geben Sie Ihr TEST- oder PRODUCTION-Zertifikat ein.';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['saferpay_paymentmethods'][1] = 'Sie können die verfügbaren Zahlungsmethoden einschränken (z. B. nur MasterCard). Wenn Sie hier nichts auswählen, sind alle Zahlungsmethoden erlaubt.';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['epay_merchantnumber'][0] = 'Händler-Nummer';
$GLOBALS['TL_LANG']['tl_iso_payment']['epay_merchantnumber'][1] = 'Die in ePay erstellte, eindeutige Händler-Nummer. Diese Händler-Nummer finden Sie in Ihren Vertrag mit PBS.';
$GLOBALS['TL_LANG']['tl_iso_payment']['epay_windowstate'][0] = 'Integrationstyp';
$GLOBALS['TL_LANG']['tl_iso_payment']['epay_windowstate'][1] = 'Wählen Sie eine der verfügbaren Integrations-Optionen. Beachten Sie bitte, dass bei Verwendung des integrierten Bezahlformulars nur Kartenzahlung akzeptiert werden kann.';
$GLOBALS['TL_LANG']['tl_iso_payment']['epay_secretkey'][0] = 'Sicherheitsschlüssel';
$GLOBALS['TL_LANG']['tl_iso_payment']['epay_secretkey'][1] = 'Der geheime Schlüssel in Ihrer ePay-Konfiguration.';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_merchantId'][1] = 'Bitte geben Sie Ihre Händler-ID ein.';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_agreementId'][0] = 'Einverständis-ID';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_agreementId'][1] = 'Bitte geben Sie Ihre Einverständnis-ID (Agreement ID) ein.';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_apiKey'][0] = 'API-Schlüssel';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_apiKey'][1] = 'Bitte geben Sie Ihren API-Schlüssel ein.';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_privateKey'][0] = 'Privater Schlüssel';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_privateKey'][1] = 'Bitte geben Sie den privaten Schlüssel ein.';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_paymentMethods'][0] = 'Zahlungsarten';
$GLOBALS['TL_LANG']['tl_iso_payment']['quickpay_paymentMethods'][1] = 'Bitte geben Sie eine Konfigurations-Zeichenfolge ein. <a href="http://tech.quickpay.net/appendixes/payment-methods/" target="_blank">Weitere Informationen</a>.';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['onlyAvailable'] = 'Nur erlauben bei folgenden Produkttypen im Warenkorb';
$GLOBALS['TL_LANG']['tl_iso_payment']['allAvailable'] = 'Nur erlauben wenn alle der folgenden Produkttypen im Warenkorb liegen';
$GLOBALS['TL_LANG']['tl_iso_payment']['oneAvailable'] = 'Erlauben, wenn einer der folgenden Produkttypen im Warenkorb liegt';
...
$GLOBALS['TL_LANG']['tl_iso_payment']['payone']['sb'] = 'Banküberweisung (SOFORT/Giropay/Postfinance/IDEAL)';
$GLOBALS['TL_LANG']['tl_iso_payment']['payone']['wlt'] = 'e-Wallet (PayPal)';
$GLOBALS['TL_LANG']['tl_iso_payment']['payone']['fnc'] = 'Finanzierung (BillSAFE Rechnung)';
$GLOBALS['TL_LANG']['tl_iso_payment']['epay_windowstate_options'][3] = 'Vollbild';
$GLOBALS['TL_LANG']['tl_iso_payment']['epay_windowstate_options'][4] = 'Integriertes Zahlungsformular';
