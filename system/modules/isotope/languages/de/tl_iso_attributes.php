...
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['value'][0] = 'Wert';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['label'][0] = 'Beschriftung';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['default'][0] = 'Standard';
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['group'][0] = 'Gruppe';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['foreignKey'][0] = 'Fremdtabelle und Feld';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['files'][0] = 'Dateien anzeigen';
$GLOBALS['TL_LANG']['tl_iso_attributes']['files'][1] = 'Klicken Sie hier um Dateien (und nicht nur Ordner) anzuzeigen.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['filesOnly'][0] = 'Nur Dateien anzeigen';
$GLOBALS['TL_LANG']['tl_iso_attributes']['filesOnly'][1] = 'Auswahl von Ordnern nicht erlauben.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['fieldType'][0] = 'Feld-Typ';
$GLOBALS['TL_LANG']['tl_iso_attributes']['fieldType'][1] = 'Wählen Sie ob eine oder mehrere Datei gewählt werden können (Radio- oder Checkbox-Auswahl).';
$GLOBALS['TL_LANG']['tl_iso_attributes']['sortBy'][0] = 'Sortieren nach';
$GLOBALS['TL_LANG']['tl_iso_attributes']['sortBy'][1] = 'Bitte wählen Sie eine Sortierreihenfolge aus.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['path'][0] = 'Basisverzeichnis';
$GLOBALS['TL_LANG']['tl_iso_attributes']['path'][1] = 'Wählen Sie ab welchem Verzeichnis die Ordnerstruktur angezeigt werden soll.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['storeFile'][0] = 'Hochgeladene Dateien speichern';
$GLOBALS['TL_LANG']['tl_iso_attributes']['storeFile'][1] = 'Die hochgeladenen Dateien in einen Ordner auf dem Server verschieben.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['uploadFolder'][0] = 'Zielverzeichnis';
$GLOBALS['TL_LANG']['tl_iso_attributes']['uploadFolder'][1] = 'Bitte wählen Sie das Zielverzeichnis aus der Dateiübersicht.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['useHomeDir'][0] = 'Benutzerverzeichnis verwenden';
$GLOBALS['TL_LANG']['tl_iso_attributes']['useHomeDir'][1] = 'Die Datei im Benutzerverzeichnis speichern, wenn sich ein Benutzer angemeldet hat.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['doNotOverwrite'][0] = 'Bestehende Dateien erhalten';
$GLOBALS['TL_LANG']['tl_iso_attributes']['doNotOverwrite'][1] = 'Der neuen Datei ein numerisches Suffix hinzufügen, wenn der Dateiname bereits existiert.';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['datepicker'][0] = 'Datumsauswahl';
$GLOBALS['TL_LANG']['tl_iso_attributes']['datepicker'][1] = 'Datumsauswahl für dieses Feld anzeigen.';
$GLOBALS['TL_LANG']['tl_iso_attributes']['checkbox'] = 'Checkbox';
$GLOBALS['TL_LANG']['tl_iso_attributes']['radio'] = 'Radio-Button';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['custom'] = 'Eigene Reihenfolge';
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['random'] = 'Zufällige Reihenfolge';
