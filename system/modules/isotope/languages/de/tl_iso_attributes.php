...
$GLOBALS['TL_LANG']['tl_iso_attributes']['files'] = array('Dateien anzeigen', 'Klicken Sie hier um Dateien (und nicht nur Ordner) anzuzeigen.');
$GLOBALS['TL_LANG']['tl_iso_attributes']['filesOnly'] = array('Nur Dateien anzeigen', 'Auswahl von Ordnern nicht erlauben.');
$GLOBALS['TL_LANG']['tl_iso_attributes']['fieldType'] = array('Feld-Typ', 'Wählen Sie ob eine oder mehrere Datei gewählt werden können (Radio- oder Checkbox-Auswahl).');
$GLOBALS['TL_LANG']['tl_iso_attributes']['sortBy'] = array('Sortieren nach', 'Bitte wählen Sie eine Sortierreihenfolge aus.');
$GLOBALS['TL_LANG']['tl_iso_attributes']['path'] = array('Basisverzeichnis', 'Wählen Sie ab welchem Verzeichnis die Ordnerstruktur angezeigt werden soll.');
...
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['value'] = array('Wert');
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['label'] = array('Beschriftung');
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['default'] = array('Standard');
$GLOBALS['TL_LANG']['tl_iso_attributes']['options']['group'] = array('Gruppe');
