...
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['postalCodes'][0] = 'Postleitzahlen';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['postalCodes'][1] = 'Limitieren Sie diese Versandmethode auf bestimmte Postleitzahlen. Sie können eine komma-getrennte Liste und Bereiche eingeben (z.B. 1234,1235,1236-1239,1100-1200).';
...
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['toggle'][0] = 'Versandmethode aktivieren/deaktivieren';
$GLOBALS['TL_LANG']['tl_iso_shipping_modules']['toggle'][1] = 'Versandmethode mit ID %s aktivieren/deaktivieren';
