...
$GLOBALS['TL_LANG']['tl_iso_mail']['priority_ref']['1']     = 'sehr hoch';
$GLOBALS['TL_LANG']['tl_iso_mail']['priority_ref']['2']     = 'hoch';
$GLOBALS['TL_LANG']['tl_iso_mail']['priority_ref']['3']     = 'normal';
$GLOBALS['TL_LANG']['tl_iso_mail']['priority_ref']['4']     = 'niedrig';
$GLOBALS['TL_LANG']['tl_iso_mail']['priority_ref']['5']     = 'sehr niedrig';
