 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_iso_mail']['new']			= array('Neue Vorlage', 'Erstellen Sie eine neue E-Mail Vorlage');
$GLOBALS['TL_LANG']['tl_iso_mail']['edit']			= array('Vorlage bearbeiten', 'E-Mail Vorlage ID %s bearbeiten');
$GLOBALS['TL_LANG']['tl_iso_mail']['copy']			= array('Vorlage kopieren', 'E-Mail Vorlage ID %s kopieren');
$GLOBALS['TL_LANG']['tl_iso_mail']['delete']		= array('Vorlage löschen', 'E-Mail Vorlage ID %s löschen');
$GLOBALS['TL_LANG']['tl_iso_mail']['show']			= array('Vorlagendetails', 'Details der E-Mail Vorlage ID %s anzeigen');
