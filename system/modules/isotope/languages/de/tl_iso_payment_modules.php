...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['price'][1] = 'Geben Sie einen prozentualen Wert ein (z.B. "10" oder "10%").';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['tax_class'][0] = 'Steuerklasse';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['tax_class'][1] = 'Bitte wählen Sie eine Steuerklasse für diesen Preis.';
...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['paypal_account'][1] = 'Geben Sie die E-Mail Adresse ein, welche als Standard ihres PayPal Kontos festgelegt ist. Beachten Sie die korrekte Schreibweise, auch Groß-Kleinschreibung!';
...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['datatrans_id'][0] = 'Händler-ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['datatrans_id'][1] = 'Bitte geben Sie Ihre Händler-ID ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['datatrans_sign'][0] = 'HMAC Schlüssel';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['datatrans_sign'][1] = 'Bitte geben Sie den HMAC Schlüssel der Datatrans-Verwaltung ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_paymentmethod'][0] = 'Zahlungsart';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_paymentmethod'][1] = 'Bitte wählen Sie eine Zahlungsart.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_paymentmethod']['creditcard'] = 'Kreditkarte';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_paymentmethod']['maestro'] = 'Abbuchungskarte';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_paymentmethod']['directdebit'] = 'Bankeinzug';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_sslmerchant'][0] = 'Verkäufer ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_sslmerchant'][1] = 'Bitte geben Sie Ihre Verkäufer ID ein (Händlerkennung).';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_sslpassword'][0] = 'Passwort';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_sslpassword'][1] = 'Bitte geben Sie Ihr SSL-Passwort ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_merchantref'][0] = 'Referenz';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sparkasse_merchantref'][1] = 'Eine Referenz, welche auf der Detailseite des Verkäufers anstelle der Warenkorbnummer angezeigt wird.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sofortueberweisung_user_id'][0] = 'Kunden ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sofortueberweisung_user_id'][1] = 'Ihre KUnden ID bei sofortüberweisung.de';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sofortueberweisung_project_id'][0] = 'Projekt ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sofortueberweisung_project_id'][1] = 'Ihre Projekt ID bei sofortüberweisung.de';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sofortueberweisung_project_password'][0] = 'Projekt-Passwort';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['sofortueberweisung_project_password'][1] = 'Ihr Projekt-Passwort bei sofortüberweisung.de';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['saferpay_accountid'][0] = 'Saferpay Account-ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['saferpay_accountid'][1] = 'Bitte geben Sie ihre eindeutige Saferpay Account ID ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['saferpay_description'][0] = 'Checkout-Beschreibung';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['saferpay_description'][1] = 'Der Kunde wird diese Beschreibung auf der Saferpay Checkout-Seite sehen';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['saferpay_vtconfig'][0] = 'Konfiguration Zahlungsseite (VTCONFIG)';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['saferpay_vtconfig'][1] = 'Sie können verschiedene Zahlseiten-Konfigurationen erstellen. Wenn Sie eine spezielle verwenden möchten, geben Sie den Wert des "Request"-Parameter hier ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_popupId'][0] = 'ExperCash Popup-ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_popupId'][1] = 'Geben Sie die Popup-ID aus Ihrem ExperCash Portal ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_profile'][0] = 'ExperCash Profil';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_profile'][1] = 'Geben Sie die dreistellige Profilnummer ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_popupKey'][0] = 'ExperCash Popup-Schlüssel';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_popupKey'][1] = 'Geben Sie den Popup-Key aus Ihrem ExperCash Portal ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_paymentMethod'][0] = 'Transaktionsart';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_paymentMethod'][1] = 'Sie können eine Transaktionsart vordefinieren oder den Kunden wählen lassen.';
...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_css'][0] = 'CSS-Vorlage';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['expercash_css'][1] = 'Wählen Sie eine CSS-Datei für die Übergabe an ExperCash.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone_clearingtype'][0] = 'Abwicklungsart';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone_clearingtype'][1] = 'Bitte wählen Sie eine Abwicklungsart.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone_aid'][0] = 'PAYONE Account-ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone_aid'][1] = 'Bitte geben Sie ihre eindeutige PAYONE Account ID ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone_portalid'][0] = 'PAYONE Portal-ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone_portalid'][1] = 'Bitte geben Sie die eindeutige PAYONE Portal ID ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone_key'][0] = 'Sicherheitsschlüssel';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone_key'][1] = 'Geben Sie den Sicherheitsschlüssel für dieses Portal ein.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_instId'][0] = 'Installation ID';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_instId'][1] = 'Bitte geben Sie die WorldPay Installation\'s ID ein';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_callbackPW'][0] = 'Transaktions-Passwort';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_callbackPW'][1] = 'Geben Sie das selbe Passwort ein, den Sie bei Ihrer WorldPay-Konfiguration eingegeben haben.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_signatureFields'][0] = 'Signaturfelder';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_signatureFields'][1] = 'Geben Sie den selben Wert für das Signaturfeld ein, den Sie bei Ihrer WorldPay-Konfiguration eingegeben haben.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_md5secret'][0] = 'MD5 Geheim';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_md5secret'][1] = 'Geben Sie den selben MD5 Geheimwert ein, den Sie bei Ihrer WorldPay-Konfiguration eingegeben haben.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_description'][0] = 'Beschreibung';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['worldpay_description'][1] = 'Geben Sie eine Beschreibung für Ihren Shop ein. Diese wird den Kunden während dem Worldpay Checkout gezeigt.';
...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['toggle'][0] = 'Zahlungsmethode aktivieren/deaktivieren';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['toggle'][1] = 'Zahlungsart ID %s aktivieren/deaktivieren';
...
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['capture'][0] = 'Authorisieren und Einnehmen';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['capture'][1] = 'Transaktionen von diesem Typ werden für die Authorisierung gesendet. Die Transaktion wird automatisch zur Begleichung geleitet wenn die Transaktion erfolgreich war.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['auth'][0] = 'Nur Authorisieren';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['auth'][1] = 'Transaktionen dieses Typs werden übertragen, wenn der Händler die Kreditkarte auf die Menge der verkauften Waren prüfen lassen möchte. Wenn der Händler nicht genügend Waren im Lager hat oder die Bestellungen vor der Warenlieferung prüfen möchte, wird dieser Transaktiontyps übertragen.';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['no_shipping'] = 'Bestellungen ohne Versand';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone']['elv'] = 'Einziehen mit Drawal';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone']['cc'] = 'Kreditkarte';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone']['dc'] = 'Bankomatkarte';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone']['vor'] = 'Vorauszahlung';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone']['rec'] = 'Rechnung';
$GLOBALS['TL_LANG']['tl_iso_payment_modules']['payone']['sb'] = 'Online Banktransfer';
