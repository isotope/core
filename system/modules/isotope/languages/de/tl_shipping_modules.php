 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_shipping_modules']['new']    			= array('Neue Versandart', 'Eine neue Versandart erstellen');
$GLOBALS['TL_LANG']['tl_shipping_modules']['edit']   			= array('Versandart bearbeiten', 'Versandart ID %s bearbeiten');
$GLOBALS['TL_LANG']['tl_shipping_modules']['copy']   			= array('Versandart duplizieren', 'Versandart ID %s duplizieren');
$GLOBALS['TL_LANG']['tl_shipping_modules']['delete'] 			= array('Versandart löschen', 'Versandart ID %s löschen');
