...
$GLOBALS['TL_LANG']['tl_store']['priceRoundPrecision']			= array('Rundungspräzision', 'Wählen Sie die Dezimal-Präzision. Wird nur verwendet wenn der Berechnungsfaktor ungleich 1 ist. Lesen Sie dazu auch das PHP-Handbuch zur Funktion round().');
