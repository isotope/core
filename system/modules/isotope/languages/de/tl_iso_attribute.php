...
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsSource'][0] = 'Optionen-Quelle';
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsSource'][1] = 'Wählen Sie aus, woher die Optionen für dieses Feld genommen werden sollen.';
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsSource']['table'] = 'Optionen-Manager';
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsSource']['product'] = 'Produkt';
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsSource']['foreignKey'] = 'Eigene Datanbank-Tabelle (foreignKey)';
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsSource']['attribute'] = 'Optionen-Assistent (veraltet)';
...
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsTable'][1] = 'Benutzen Sie den Options Manager um dem Feld Optionen hinzuzufügen.';
$GLOBALS['TL_LANG']['tl_iso_attribute']['includeBlankOption'][0] = 'Leerauswahl einfügen';
$GLOBALS['TL_LANG']['tl_iso_attribute']['includeBlankOption'][1] = 'Hier klicken um dem Select-Menü eine leere Auswahl hinzuzufügen.';
$GLOBALS['TL_LANG']['tl_iso_attribute']['blankOptionLabel'][0] = 'Beschriftung für die Leerauswahl';
$GLOBALS['TL_LANG']['tl_iso_attribute']['blankOptionLabel'][1] = 'Sie können optional eine Beschriftung für die Leerauswahl angeben. Wenn Sie hier nichts eingeben wird ein Strich (-) angezeigt.';
...
$GLOBALS['TL_LANG']['tl_iso_attribute']['placeholder'][0] = 'Platzhalter';
$GLOBALS['TL_LANG']['tl_iso_attribute']['placeholder'][1] = 'Zeigen Sie diesen Text an, solange das Feld leer ist (benötigt HTML5).';
$GLOBALS['TL_LANG']['tl_iso_attribute']['minlength'][0] = 'Mindestlänge';
...
$GLOBALS['TL_LANG']['tl_iso_attribute']['checkoutTargetFolder'][0] = 'Zielverzeichnis';
...
$GLOBALS['TL_LANG']['tl_iso_attribute']['optionsTable_edit'] = 'Optionen bearbeiten';
...
$GLOBALS['TL_LANG']['tl_iso_attribute']['checkout_tokens'][1][0] = '##document_number##';
