...
CREATE TABLE `tl_iso_config` (
  ...
  `gallery_watermark` varchar(255) NOT NULL default '',
  `thumbnail_watermark` varchar(255) NOT NULL default '',
  `medium_watermark` varchar(255) NOT NULL default '',
  `large_watermark` varchar(255) NOT NULL default '',
  `watermark_position` varchar(2) NOT NULL default '',
  `archive` int(1) unsigned NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
