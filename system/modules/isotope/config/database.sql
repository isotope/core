...
CREATE TABLE `tl_iso_config` (
  ...
  `iso_product_add_jumpTo` int(10) unsigned NOT NULL default '0',
...
CREATE TABLE `tl_iso_shipping_modules` (
  ...
  `minimum_total` varchar(32) NOT NULL default '',
  `maximum_total` varchar(32) NOT NULL default '',
  `price` float NOT NULL default '0',
...
CREATE TABLE `tl_iso_orders` (
  ...
  `taxTotal` float NOT NULL default '0',
