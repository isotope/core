				...
				foreach($product as $k=>$v)
				{
					...
					switch($k)
					{
						...
						case "alias":
							...
							{	
								$arrImages = $this->getProductImages($arrProductPaths['file_destination_path'], $arrProductPaths['relative_destination_path'], $product, $GLOBALS['TL_LANG']['MSC']['imagesFolder'], $product['images'], $product['alias']);
