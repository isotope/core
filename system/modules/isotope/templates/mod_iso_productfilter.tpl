<div class="<?php echo $this->class; ?> block"<?php echo $this->cssID; ?><?php if ($this->style): ?> style="<?php echo $this->style; ?>"<?php endif; ?>>
    ...
    <div class="formbody">
        <form id="filterForm" action="<?php echo $this->action; ?>" method="<?php echo ($this->script ? "get" : "post"); ?>">            
            <?php if($this->orderBy): ?>
            ...
            <?php endif; ?>
                <div class="submit_container">
                    <button type="<?php echo (!$this->script ? "button" : "submit"); ?>" name="search" id="ctrl_search"><?php echo $this->submitLabel; ?></button>
                </div>
                <?php if($this->script): ?>        	 
