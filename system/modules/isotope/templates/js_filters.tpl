...
window.addEvent('domready', function() {
	...
	IsotopeFrontend.modifyPagination(ajaxParams);
	...
	ctrlClear.addEvent('click', function(event) {
		...
		var req = new Request({
			...
			onSuccess: function(responseText, responseXML) { IsotopeFrontend.insertProductList(responseText); IsotopeFrontend.hideLoader(); IsotopeFrontend.loadProductBinders(mId); }
		}).send();		
	});
