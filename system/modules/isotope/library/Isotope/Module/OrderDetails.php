...
class OrderDetails extends Module
{
    ...
    protected function compile()
    {
        ...
        $this->Template->billing_address = $objOrder->getBillingAddress()->generateHtml(Isotope::getConfig()->billing_fields);
        ...
        if (strlen($objOrder->shipping_method))
        {
            ...
            else
            {
                ...
                $this->Template->shipping_address = $objOrder->getShippingAddress()->generateHtml(Isotope::getConfig()->shipping_fields);
            }
        }
    }
