...
class Upgrade extends \Controller
{
    ...
    private function renameFields()
    {
        ...
        // tl_iso_attributes.is_required has been renamed to tl_iso_attributes.mandatory
        if (in_array('isotope_imageselect', \Config::getInstance()->getActiveModules()) && $this->Database->fieldExists('size', 'tl_iso_attributes') && !$this->Database->fieldExists('imgSize', 'tl_iso_attributes'))
        {
