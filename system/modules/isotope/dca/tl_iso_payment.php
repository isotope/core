...
(
    ...
    (
        ...
        'saferpay'                  => '{type_legend},name,label,type;{note_legend:hide},note;{config_legend},new_order_status,minimum_total,maximum_total,countries,shipping_modules,product_types,product_types_condition,config_ids;{gateway_legend},saferpay_accountid,trans_type,saferpay_description,saferpay_vtconfig,saferpay_providerset;{price_legend:hide},price,tax_class;{enabled_legend},enabled',
        'billpay_saferpay'          => '{type_legend},name,label,type;{note_legend:hide},note;{config_legend},new_order_status,minimum_total,maximum_total,countries,shipping_modules,product_types;{gateway_legend},saferpay_accountid,trans_type,saferpay_description,saferpay_vtconfig,saferpay_providerset;{price_legend:hide},price,tax_class;{enabled_legend},enabled',
    ...
    (
        ...
        'saferpay_providerset' => array
        (
            'label'                 => &$GLOBALS['TL_LANG']['tl_iso_payment']['saferpay_providerset'],
            'inputType'             => 'text',
            'eval'                  => array('maxlength'=>255, 'tl_class'=>'w50'),
            'sql'                   => "varchar(255) NOT NULL default ''",
        ),
