...
$GLOBALS['TL_DCA']['tl_module']['fields']['iso_hide_options'] = array
(
    'label'                     => &$GLOBALS['TL_LANG']['tl_module']['iso_hide_options'],
    'exclude'                   => true,
    'inputType'                 => 'checkbox',
    'eval'                      => array('tl_class'=>'w50'),
    'sql'                       => "char(1) NOT NULL default ''",
...
(
    'label'                     => &$GLOBALS['TL_LANG']['tl_module']['iso_rangeFields'],
    'exclude'                   => true,
    'inputType'                 => 'multiColumnWizard',
    'eval'                      => array(
        'mandatory' => true,
