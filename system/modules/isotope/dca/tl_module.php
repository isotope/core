...
$GLOBALS['TL_DCA']['tl_module']['palettes']['iso_favorites']                = '{title_legend},name,headline,type;{template_legend},customTpl,iso_collectionTpl,iso_orderCollectionBy,iso_gallery,iso_includeMessages,iso_use_quantity,iso_emptyMessage;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
...
$GLOBALS['TL_DCA']['tl_module']['fields']['iso_skip_shipping'] = array
(
    'label'                     => &$GLOBALS['TL_LANG']['tl_module']['iso_skip_shipping'],
    'exclude'                   => true,
    'inputType'                 => 'checkbox',
    'sql'                       => "char(1) NOT NULL default ''",
);

$GLOBALS['TL_DCA']['tl_module']['fields']['iso_skip_payment'] = array
(
    'label'                     => &$GLOBALS['TL_LANG']['tl_module']['iso_skip_payment'],
    'exclude'                   => true,
    'inputType'                 => 'checkbox',
    'sql'                       => "char(1) NOT NULL default ''",
);
