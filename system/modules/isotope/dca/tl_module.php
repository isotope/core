...
$GLOBALS['TL_DCA']['tl_module']['fields']['iso_jump_exact'] = array
(
    'label'                     => &$GLOBALS['TL_LANG']['tl_module']['iso_jump_exact'],
    'exclude'                   => true,
    'inputType'                 => 'select',
