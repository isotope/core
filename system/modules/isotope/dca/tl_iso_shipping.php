...
(
    ...
    (
        ...
        'flat'                      => '{title_legend},name,label,type;{note_legend:hide},note;{price_legend},price,tax_class,flatCalculation;{config_legend},countries,subdivisions,postalCodes,minimum_total,maximum_total,minimum_weight,maximum_weight,product_types,config_ids;{expert_legend:hide},guests,protected;{enabled_legend},enabled',
