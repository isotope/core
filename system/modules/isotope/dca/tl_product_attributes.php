...
(
    ...
    (
		...
		'integer'					=> 'name,description,type,field_name,is_visible_on_front;is_hidden_on_backend;is_customer_defined;is_required,is_filterable,is_searchable,is_order_by_enabled,is_used_for_price_rules,is_listing_field;load_callback;save_callback',
		...
		'select'					=> 'name,description,type,field_name,option_list,is_visible_on_front;is_hidden_on_backend;is_customer_defined;is_required,is_filterable,is_searchable,is_multiple_select,is_order_by_enabled,is_listing_field;use_alternate_source;load_callback;save_callback',
		'boolean'					=> 'name,description,type,field_name,is_visible_on_front;is_hidden_on_backend;is_customer_defined;is_required,is_filterable,is_searchable,is_multiple_select,is_order_by_enabled,is_listing_field;load_callback;save_callback',
		'options'					=> 'name,description,type,field_name,option_list,is_visible_on_front;is_hidden_on_backend;is_customer_defined;is_required,is_filterable,is_searchable,is_multiple_select,is_order_by_enabled,is_listing_field;load_callback;save_callback',
		'fileattach'				=> 'name,description,type,field_name,is_visible_on_front;is_hidden_on_backend;is_customer_defined;is_required,is_filterable,is_searchable,is_listing_field;load_callback;save_callback',
